#!/usr/bin/env python3
"""Run generated space: immunology-adaptive-immunity-combo-0001."""
...
def _repo_root_map(current_repo_root: Path) -> dict[str, Path]:
    ...
    return {
        "Biosimulant/models-immunology": current_repo_root.resolve(),
...
def main() -> None:
    ...
    print(f"Completed {space.get('title', 'immunology-adaptive-immunity-combo-0001')} duration={duration} tick_dt={tick_dt}")
