...
"""Auto-generated SBML BioModule wrapper for Yamada2003_JAK_STAT_SOCS1_knockout.

Source: biomodels_ebi:BIOMD0000000094
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000094
"""
...
class SbmlYamada2003JakStatSocs1Knockout(biosim.BioModule):
    """BioModule wrapper for SBML model: Yamada2003_JAK_STAT_SOCS1_knockout."""

    def __init__(self, model_path: str = "data/BIOMD0000000094.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Yamada2003JakStatSocs1KnockoutBiomd0000000094Model = SbmlYamada2003JakStatSocs1Knockout
