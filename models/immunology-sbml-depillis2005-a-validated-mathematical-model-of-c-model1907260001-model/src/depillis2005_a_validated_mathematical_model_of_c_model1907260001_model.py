...
"""Auto-generated SBML BioModule wrapper for dePillis2005 - A validated mathematical model of cell-mediated immune response to tumor growth.

Source: biomodels_ebi:MODEL1907260001
Original: https://www.ebi.ac.uk/biomodels/MODEL1907260001
"""
...
class SbmlDepillis2005AValidatedMathematicalModelOfCell(biosim.BioModule):
    """BioModule wrapper for SBML model: dePillis2005 - A validated mathematical model of cell-mediated immune response to tumor growth."""

    def __init__(self, model_path: str = "data/MODEL1907260001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Depillis2005AValidatedMathematicalModelOfCModel1907260001Model = SbmlDepillis2005AValidatedMathematicalModelOfCell
