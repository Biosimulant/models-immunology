...
"""Auto-generated SBML BioModule wrapper for Robertson-Tessi M 2012 A model of tumor Immune interaction.

Source: biomodels_ebi:BIOMD0000000731
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000731
"""
...
class SbmlRobertsonTessiM2012AModelOfTumorImmuneInteraction(biosim.BioModule):
    """BioModule wrapper for SBML model: Robertson-Tessi M 2012 A model of tumor Immune interaction."""

    def __init__(self, model_path: str = "data/BIOMD0000000731.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
RobertsonTessiM2012AModelOfTumorImmuneIBiomd0000000731Model = SbmlRobertsonTessiM2012AModelOfTumorImmuneInteraction
