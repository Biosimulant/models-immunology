...
"""Auto-generated SBML BioModule wrapper for Owen1998 - Tumour  treatment model.

Source: biomodels_ebi:BIOMD0000000650
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000650
"""
...
class SbmlOwen1998TumourTreatmentModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Owen1998 - Tumour  treatment model."""

    def __init__(self, model_path: str = "data/BIOMD0000000650.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Owen1998TumourTreatmentModelBiomd0000000650Model = SbmlOwen1998TumourTreatmentModel
