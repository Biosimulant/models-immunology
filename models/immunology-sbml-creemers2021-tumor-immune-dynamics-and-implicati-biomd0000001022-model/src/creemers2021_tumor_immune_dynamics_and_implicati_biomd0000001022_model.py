...
"""Auto-generated SBML BioModule wrapper for Creemers2021 - Tumor-immune dynamics and implications on immunotherapy responses.

Source: biomodels_ebi:BIOMD0000001022
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001022
"""
...
class SbmlCreemers2021TumorImmuneDynamicsAndImplicationsOn(biosim.BioModule):
    """BioModule wrapper for SBML model: Creemers2021 - Tumor-immune dynamics and implications on immunotherapy responses."""

    def __init__(self, model_path: str = "data/BIOMD0000001022.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Creemers2021TumorImmuneDynamicsAndImplicatiBiomd0000001022Model = SbmlCreemers2021TumorImmuneDynamicsAndImplicationsOn
