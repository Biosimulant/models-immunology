...
"""Auto-generated SBML BioModule wrapper for Perelson1993 - HIVinfection_CD4Tcells_ModelA.

Source: biomodels_ebi:BIOMD0000000874
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000874
"""
...
class SbmlPerelson1993HivinfectionCd4tcellsModela(biosim.BioModule):
    """BioModule wrapper for SBML model: Perelson1993 - HIVinfection_CD4Tcells_ModelA."""

    def __init__(self, model_path: str = "data/BIOMD0000000874.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Perelson1993HivinfectionCd4tcellsModelaBiomd0000000874Model = SbmlPerelson1993HivinfectionCd4tcellsModela
