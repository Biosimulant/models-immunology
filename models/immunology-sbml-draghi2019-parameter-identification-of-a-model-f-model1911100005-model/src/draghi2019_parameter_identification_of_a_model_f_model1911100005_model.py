...
"""Auto-generated SBML BioModule wrapper for Draghi2019 - Parameter identification of a model for prostate cancer treated by intermittent therapy.

Source: biomodels_ebi:MODEL1911100005
Original: https://www.ebi.ac.uk/biomodels/MODEL1911100005
"""
...
class SbmlDraghi2019ParameterIdentificationOfAModelForProstate(biosim.BioModule):
    """BioModule wrapper for SBML model: Draghi2019 - Parameter identification of a model for prostate cancer treated by intermittent therapy."""

    def __init__(self, model_path: str = "data/MODEL1911100005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Draghi2019ParameterIdentificationOfAModelFModel1911100005Model = SbmlDraghi2019ParameterIdentificationOfAModelForProstate
