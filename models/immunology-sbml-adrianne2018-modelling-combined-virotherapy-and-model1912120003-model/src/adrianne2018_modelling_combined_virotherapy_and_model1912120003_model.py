...
"""Auto-generated SBML BioModule wrapper for Adrianne2018 - Modelling combined virotherapy and immunotherapy: strengthening the antitumour immune response mediated by IL-12 and GM-CSF expression.

Source: biomodels_ebi:MODEL1912120003
Original: https://www.ebi.ac.uk/biomodels/MODEL1912120003
"""
...
class SbmlAdrianne2018ModellingCombinedVirotherapyAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Adrianne2018 - Modelling combined virotherapy and immunotherapy: strengthening the antitumour immune response mediated by IL-12 and GM-CSF expression."""

    def __init__(self, model_path: str = "data/MODEL1912120003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Adrianne2018ModellingCombinedVirotherapyAndModel1912120003Model = SbmlAdrianne2018ModellingCombinedVirotherapyAnd
