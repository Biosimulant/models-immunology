...
"""Auto-generated SBML BioModule wrapper for Jarrett2015 - Modelling the interaction between immune response, bacterial dynamics and inflammatory damage.

Source: biomodels_ebi:BIOMD0000000920
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000920
"""
...
class SbmlJarrett2015ModellingTheInteractionBetweenImmune(biosim.BioModule):
    """BioModule wrapper for SBML model: Jarrett2015 - Modelling the interaction between immune response, bacterial dynamics and inflammatory damage."""

    def __init__(self, model_path: str = "data/BIOMD0000000920.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Jarrett2015ModellingTheInteractionBetweenImBiomd0000000920Model = SbmlJarrett2015ModellingTheInteractionBetweenImmune
