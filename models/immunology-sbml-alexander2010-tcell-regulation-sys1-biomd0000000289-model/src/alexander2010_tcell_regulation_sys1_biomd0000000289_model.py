...
"""Auto-generated SBML BioModule wrapper for Alexander2010_Tcell_Regulation_Sys1.

Source: biomodels_ebi:BIOMD0000000289
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000289
"""
...
class SbmlAlexander2010TcellRegulationSys1(biosim.BioModule):
    """BioModule wrapper for SBML model: Alexander2010_Tcell_Regulation_Sys1."""

    def __init__(self, model_path: str = "data/BIOMD0000000289.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Alexander2010TcellRegulationSys1Biomd0000000289Model = SbmlAlexander2010TcellRegulationSys1
