...
"""Auto-generated SBML BioModule wrapper for Restif2007 - Vaccination invasion.

Source: biomodels_ebi:BIOMD0000000294
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000294
"""
...
class SbmlRestif2007VaccinationInvasion(biosim.BioModule):
    """BioModule wrapper for SBML model: Restif2007 - Vaccination invasion."""

    def __init__(self, model_path: str = "data/BIOMD0000000294.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Restif2007VaccinationInvasionBiomd0000000294Model = SbmlRestif2007VaccinationInvasion
