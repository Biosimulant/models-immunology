...
"""Auto-generated SBML BioModule wrapper for Yates2007_TcellHomeostasisProliferation.

Source: biomodels_ebi:MODEL4028801312
Original: https://www.ebi.ac.uk/biomodels/MODEL4028801312
"""
...
class SbmlYates2007Tcellhomeostasisproliferation(biosim.BioModule):
    """BioModule wrapper for SBML model: Yates2007_TcellHomeostasisProliferation."""

    def __init__(self, model_path: str = "data/MODEL4028801312.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Yates2007TcellhomeostasisproliferationModel4028801312Model = SbmlYates2007Tcellhomeostasisproliferation
