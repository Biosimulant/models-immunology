...
"""Auto-generated SBML BioModule wrapper for Isaeva2009 - Different strategies for cancer treatment.

Source: biomodels_ebi:MODEL2001140002
Original: https://www.ebi.ac.uk/biomodels/MODEL2001140002
"""
...
class SbmlIsaeva2009DifferentStrategiesForCancerTreatment(biosim.BioModule):
    """BioModule wrapper for SBML model: Isaeva2009 - Different strategies for cancer treatment."""

    def __init__(self, model_path: str = "data/MODEL2001140002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Isaeva2009DifferentStrategiesForCancerTreatModel2001140002Model = SbmlIsaeva2009DifferentStrategiesForCancerTreatment
