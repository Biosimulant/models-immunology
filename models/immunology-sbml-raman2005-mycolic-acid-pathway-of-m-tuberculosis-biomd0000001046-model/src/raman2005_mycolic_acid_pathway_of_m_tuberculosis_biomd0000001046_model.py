...
"""Auto-generated SBML BioModule wrapper for Raman2005 - Mycolic acid pathway of M. tuberculosis.

Source: biomodels_ebi:BIOMD0000001046
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001046
"""
...
class SbmlRaman2005MycolicAcidPathwayOfMTuberculosis(biosim.BioModule):
    """BioModule wrapper for SBML model: Raman2005 - Mycolic acid pathway of M. tuberculosis."""

    def __init__(self, model_path: str = "data/BIOMD0000001046.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Raman2005MycolicAcidPathwayOfMTuberculosisBiomd0000001046Model = SbmlRaman2005MycolicAcidPathwayOfMTuberculosis
