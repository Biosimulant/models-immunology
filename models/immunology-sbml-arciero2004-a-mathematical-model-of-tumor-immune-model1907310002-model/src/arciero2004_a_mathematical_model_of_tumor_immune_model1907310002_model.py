...
"""Auto-generated SBML BioModule wrapper for Arciero2004 - A mathematical model of tumor-immune evasion and siRNA treatment.

Source: biomodels_ebi:MODEL1907310002
Original: https://www.ebi.ac.uk/biomodels/MODEL1907310002
"""
...
class SbmlArciero2004AMathematicalModelOfTumorImmuneEvasion(biosim.BioModule):
    """BioModule wrapper for SBML model: Arciero2004 - A mathematical model of tumor-immune evasion and siRNA treatment."""

    def __init__(self, model_path: str = "data/MODEL1907310002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Arciero2004AMathematicalModelOfTumorImmuneModel1907310002Model = SbmlArciero2004AMathematicalModelOfTumorImmuneEvasion
