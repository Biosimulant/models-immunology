...
"""Auto-generated SBML BioModule wrapper for Zerrouk2023 - Large scale computational modeling of the M2 synovial macrophage in rheumatoid arthritis.

Source: biomodels_ebi:MODEL2307180002
Original: https://www.ebi.ac.uk/biomodels/MODEL2307180002
"""
...
class SbmlZerrouk2023LargeScaleComputationalModelingOfTheM2(biosim.BioModule):
    """BioModule wrapper for SBML model: Zerrouk2023 - Large scale computational modeling of the M2 synovial macrophage in rheumatoid arthritis."""

    def __init__(self, model_path: str = "data/MODEL2307180002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zerrouk2023LargeScaleComputationalModelingOModel2307180002Model = SbmlZerrouk2023LargeScaleComputationalModelingOfTheM2
