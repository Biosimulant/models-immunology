...
"""Auto-generated SBML BioModule wrapper for FatehiChenar2018 - Mathematical model of immune response to hepatitis B.

Source: biomodels_ebi:BIOMD0000000848
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000848
"""
...
class SbmlFatehichenar2018MathematicalModelOfImmuneResponseTo(biosim.BioModule):
    """BioModule wrapper for SBML model: FatehiChenar2018 - Mathematical model of immune response to hepatitis B."""

    def __init__(self, model_path: str = "data/BIOMD0000000848.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Fatehichenar2018MathematicalModelOfImmuneReBiomd0000000848Model = SbmlFatehichenar2018MathematicalModelOfImmuneResponseTo
