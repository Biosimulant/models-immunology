...
"""Auto-generated SBML BioModule wrapper for Bordbar2010_M_tuberculosis_Macrophage.

Source: biomodels_ebi:MODEL1011090002
Original: https://www.ebi.ac.uk/biomodels/MODEL1011090002
"""
...
class SbmlBordbar2010MTuberculosisMacrophage(biosim.BioModule):
    """BioModule wrapper for SBML model: Bordbar2010_M_tuberculosis_Macrophage."""

    def __init__(self, model_path: str = "data/MODEL1011090002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bordbar2010MTuberculosisMacrophageModel1011090002Model = SbmlBordbar2010MTuberculosisMacrophage
