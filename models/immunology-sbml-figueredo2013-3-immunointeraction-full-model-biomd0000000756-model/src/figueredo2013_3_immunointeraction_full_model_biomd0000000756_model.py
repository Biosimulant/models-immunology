...
"""Auto-generated SBML BioModule wrapper for Figueredo2013/3 - immunointeraction full model.

Source: biomodels_ebi:BIOMD0000000756
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000756
"""
...
class SbmlFigueredo20133ImmunointeractionFullModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Figueredo2013/3 - immunointeraction full model."""

    def __init__(self, model_path: str = "data/BIOMD0000000756.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Figueredo20133ImmunointeractionFullModelBiomd0000000756Model = SbmlFigueredo20133ImmunointeractionFullModel
