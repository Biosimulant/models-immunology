...
"""Auto-generated SBML BioModule wrapper for Geißert2020 - Yersinia enterocolitica co-infection in mice.

Source: biomodels_ebi:MODEL2002070001
Original: https://www.ebi.ac.uk/biomodels/MODEL2002070001
"""
...
class SbmlGeiert2020YersiniaEnterocoliticaCoInfectionInMice(biosim.BioModule):
    """BioModule wrapper for SBML model: Geißert2020 - Yersinia enterocolitica co-infection in mice."""

    def __init__(self, model_path: str = "data/MODEL2002070001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
GeiErt2020YersiniaEnterocoliticaCoInfectionModel2002070001Model = SbmlGeiert2020YersiniaEnterocoliticaCoInfectionInMice
