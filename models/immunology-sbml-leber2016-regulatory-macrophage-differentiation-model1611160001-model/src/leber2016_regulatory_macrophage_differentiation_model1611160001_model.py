...
"""Auto-generated SBML BioModule wrapper for Leber2016 - Regulatory macrophage differentiation - H.pylori infection.

Source: biomodels_ebi:MODEL1611160001
Original: https://www.ebi.ac.uk/biomodels/MODEL1611160001
"""
...
class SbmlLeber2016RegulatoryMacrophageDifferentiationHPylori(biosim.BioModule):
    """BioModule wrapper for SBML model: Leber2016 - Regulatory macrophage differentiation - H.pylori infection."""

    def __init__(self, model_path: str = "data/MODEL1611160001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Leber2016RegulatoryMacrophageDifferentiationModel1611160001Model = SbmlLeber2016RegulatoryMacrophageDifferentiationHPylori
