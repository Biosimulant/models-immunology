...
"""Auto-generated SBML BioModule wrapper for Ledzewicz2013 - On optimal chemotherapy with a strongly targeted agent for a model of tumor immune system interactions with generalized logistic growth.

Source: biomodels_ebi:BIOMD0000000919
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000919
"""
...
class SbmlLedzewicz2013OnOptimalChemotherapyWithAStrongly(biosim.BioModule):
    """BioModule wrapper for SBML model: Ledzewicz2013 - On optimal chemotherapy with a strongly targeted agent for a model of tumor immune system interactions with generalized logistic growth."""

    def __init__(self, model_path: str = "data/BIOMD0000000919.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ledzewicz2013OnOptimalChemotherapyWithAStrBiomd0000000919Model = SbmlLedzewicz2013OnOptimalChemotherapyWithAStrongly
