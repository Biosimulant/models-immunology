...
"""Auto-generated SBML BioModule wrapper for Santos2016 - Gene signatures of immune sensitivity and resistance in melanoma micrometastatis.

Source: biomodels_ebi:MODEL1604260000
Original: https://www.ebi.ac.uk/biomodels/MODEL1604260000
"""
...
class SbmlSantos2016GeneSignaturesOfImmuneSensitivityAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Santos2016 - Gene signatures of immune sensitivity and resistance in melanoma micrometastatis."""

    def __init__(self, model_path: str = "data/MODEL1604260000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Santos2016GeneSignaturesOfImmuneSensitivityModel1604260000Model = SbmlSantos2016GeneSignaturesOfImmuneSensitivityAnd
