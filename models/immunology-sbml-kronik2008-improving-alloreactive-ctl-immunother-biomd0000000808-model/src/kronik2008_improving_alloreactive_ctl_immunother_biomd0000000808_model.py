...
"""Auto-generated SBML BioModule wrapper for Kronik2008 - Improving alloreactive CTL immunotherapy for malignant gliomas using a simulation model of their interactive dynamics.

Source: biomodels_ebi:BIOMD0000000808
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000808
"""
...
class SbmlKronik2008ImprovingAlloreactiveCtlImmunotherapyFor(biosim.BioModule):
    """BioModule wrapper for SBML model: Kronik2008 - Improving alloreactive CTL immunotherapy for malignant gliomas using a simulation model of their interactive dynamics."""

    def __init__(self, model_path: str = "data/BIOMD0000000808.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kronik2008ImprovingAlloreactiveCtlImmunotherBiomd0000000808Model = SbmlKronik2008ImprovingAlloreactiveCtlImmunotherapyFor
