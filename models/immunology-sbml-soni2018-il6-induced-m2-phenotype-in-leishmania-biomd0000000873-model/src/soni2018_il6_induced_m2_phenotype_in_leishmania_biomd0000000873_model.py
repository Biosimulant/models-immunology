...
"""Auto-generated SBML BioModule wrapper for Soni2018 - IL6 induced M2 Phenotype in Leishmania major infected macrophage.

Source: biomodels_ebi:BIOMD0000000873
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000873
"""
...
class SbmlSoni2018Il6InducedM2PhenotypeInLeishmaniaMajor(biosim.BioModule):
    """BioModule wrapper for SBML model: Soni2018 - IL6 induced M2 Phenotype in Leishmania major infected macrophage."""

    def __init__(self, model_path: str = "data/BIOMD0000000873.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Soni2018Il6InducedM2PhenotypeInLeishmaniaBiomd0000000873Model = SbmlSoni2018Il6InducedM2PhenotypeInLeishmaniaMajor
