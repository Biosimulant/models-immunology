...
"""Auto-generated SBML BioModule wrapper for Carbo2013 - Cytokine driven CD4+ T Cell differentiation and phenotype plasticity.

Source: biomodels_ebi:BIOMD0000000451
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000451
"""
...
class SbmlCarbo2013CytokineDrivenCd4TCellDifferentiationAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Carbo2013 - Cytokine driven CD4+ T Cell differentiation and phenotype plasticity."""

    def __init__(self, model_path: str = "data/BIOMD0000000451.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Carbo2013CytokineDrivenCd4TCellDifferentiaBiomd0000000451Model = SbmlCarbo2013CytokineDrivenCd4TCellDifferentiationAnd
