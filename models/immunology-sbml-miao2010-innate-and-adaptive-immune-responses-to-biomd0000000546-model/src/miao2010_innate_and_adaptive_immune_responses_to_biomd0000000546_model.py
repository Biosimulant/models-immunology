...
"""Auto-generated SBML BioModule wrapper for Miao2010 - Innate and adaptive immune responses to primary Influenza A Virus infection_1_1.

Source: biomodels_ebi:BIOMD0000000546
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000546
"""
...
class SbmlMiao2010InnateAndAdaptiveImmuneResponsesToPrimary(biosim.BioModule):
    """BioModule wrapper for SBML model: Miao2010 - Innate and adaptive immune responses to primary Influenza A Virus infection_1_1."""

    def __init__(self, model_path: str = "data/BIOMD0000000546.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Miao2010InnateAndAdaptiveImmuneResponsesToBiomd0000000546Model = SbmlMiao2010InnateAndAdaptiveImmuneResponsesToPrimary
