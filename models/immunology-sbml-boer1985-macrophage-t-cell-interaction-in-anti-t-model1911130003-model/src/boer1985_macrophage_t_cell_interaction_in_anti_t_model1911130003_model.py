...
"""Auto-generated SBML BioModule wrapper for Boer1985 - Macrophage T cell interaction in anti-tumor response.

Source: biomodels_ebi:MODEL1911130003
Original: https://www.ebi.ac.uk/biomodels/MODEL1911130003
"""
...
class SbmlBoer1985MacrophageTCellInteractionInAntiTumor(biosim.BioModule):
    """BioModule wrapper for SBML model: Boer1985 - Macrophage T cell interaction in anti-tumor response."""

    def __init__(self, model_path: str = "data/MODEL1911130003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Boer1985MacrophageTCellInteractionInAntiTModel1911130003Model = SbmlBoer1985MacrophageTCellInteractionInAntiTumor
