...
"""Auto-generated SBML BioModule wrapper for Sanchez2017 -  Inflammatory responses during acute hyperinsulinemia.

Source: biomodels_ebi:MODEL1606020000
Original: https://www.ebi.ac.uk/biomodels/MODEL1606020000
"""
...
class SbmlSanchez2017InflammatoryResponsesDuringAcute(biosim.BioModule):
    """BioModule wrapper for SBML model: Sanchez2017 -  Inflammatory responses during acute hyperinsulinemia."""

    def __init__(self, model_path: str = "data/MODEL1606020000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sanchez2017InflammatoryResponsesDuringAcuteModel1606020000Model = SbmlSanchez2017InflammatoryResponsesDuringAcute
