...
"""Auto-generated SBML BioModule wrapper for Fribourg2014 - Dynamics of viral antagonism and innate immune response (H1N1 influenza A virus - NC/99).

Source: biomodels_ebi:BIOMD0000000529
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000529
"""
...
class SbmlFribourg2014DynamicsOfViralAntagonismAndInnateImmune(biosim.BioModule):
    """BioModule wrapper for SBML model: Fribourg2014 - Dynamics of viral antagonism and innate immune response (H1N1 influenza A virus - NC/99)."""

    def __init__(self, model_path: str = "data/BIOMD0000000529.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Fribourg2014DynamicsOfViralAntagonismAndInBiomd0000000529Model = SbmlFribourg2014DynamicsOfViralAntagonismAndInnateImmune
