...
"""Auto-generated SBML BioModule wrapper for Maier2022 - Stochastic Dynamics of Type I Interferon Responses.

Source: biomodels_ebi:MODEL2210070001
Original: https://www.ebi.ac.uk/biomodels/MODEL2210070001
"""
...
class SbmlMaier2022StochasticDynamicsOfTypeIInterferonResponses(biosim.BioModule):
    """BioModule wrapper for SBML model: Maier2022 - Stochastic Dynamics of Type I Interferon Responses."""

    def __init__(self, model_path: str = "data/MODEL2210070001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Maier2022StochasticDynamicsOfTypeIInterferModel2210070001Model = SbmlMaier2022StochasticDynamicsOfTypeIInterferonResponses
