...
"""Auto-generated SBML BioModule wrapper for Lee2009 - Adaptive immune response to Influenza A Virus infection.

Source: biomodels_ebi:MODEL1406230000
Original: https://www.ebi.ac.uk/biomodels/MODEL1406230000
"""
...
class SbmlLee2009AdaptiveImmuneResponseToInfluenzaAVirus(biosim.BioModule):
    """BioModule wrapper for SBML model: Lee2009 - Adaptive immune response to Influenza A Virus infection."""

    def __init__(self, model_path: str = "data/MODEL1406230000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lee2009AdaptiveImmuneResponseToInfluenzaAModel1406230000Model = SbmlLee2009AdaptiveImmuneResponseToInfluenzaAVirus
