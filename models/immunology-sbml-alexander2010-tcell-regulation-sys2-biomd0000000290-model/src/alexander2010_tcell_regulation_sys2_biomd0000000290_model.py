...
"""Auto-generated SBML BioModule wrapper for Alexander2010_Tcell_Regulation_Sys2.

Source: biomodels_ebi:BIOMD0000000290
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000290
"""
...
class SbmlAlexander2010TcellRegulationSys2(biosim.BioModule):
    """BioModule wrapper for SBML model: Alexander2010_Tcell_Regulation_Sys2."""

    def __init__(self, model_path: str = "data/BIOMD0000000290.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Alexander2010TcellRegulationSys2Biomd0000000290Model = SbmlAlexander2010TcellRegulationSys2
