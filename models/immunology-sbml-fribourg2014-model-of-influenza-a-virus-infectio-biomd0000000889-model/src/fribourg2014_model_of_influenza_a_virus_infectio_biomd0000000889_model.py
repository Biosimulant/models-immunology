...
"""Auto-generated SBML BioModule wrapper for Fribourg2014 - Model of influenza A virus infection dynamics of viral antagonism and innate immune response..

Source: biomodels_ebi:BIOMD0000000889
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000889
"""
...
class SbmlFribourg2014ModelOfInfluenzaAVirusInfectionDynamics(biosim.BioModule):
    """BioModule wrapper for SBML model: Fribourg2014 - Model of influenza A virus infection dynamics of viral antagonism and innate immune response.."""

    def __init__(self, model_path: str = "data/BIOMD0000000889.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Fribourg2014ModelOfInfluenzaAVirusInfectioBiomd0000000889Model = SbmlFribourg2014ModelOfInfluenzaAVirusInfectionDynamics
