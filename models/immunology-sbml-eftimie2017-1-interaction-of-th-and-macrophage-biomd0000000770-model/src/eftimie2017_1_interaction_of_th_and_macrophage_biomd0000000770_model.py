...
"""Auto-generated SBML BioModule wrapper for Eftimie2017/1 - interaction of Th and macrophage.

Source: biomodels_ebi:BIOMD0000000770
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000770
"""
...
class SbmlEftimie20171InteractionOfThAndMacrophage(biosim.BioModule):
    """BioModule wrapper for SBML model: Eftimie2017/1 - interaction of Th and macrophage."""

    def __init__(self, model_path: str = "data/BIOMD0000000770.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Eftimie20171InteractionOfThAndMacrophageBiomd0000000770Model = SbmlEftimie20171InteractionOfThAndMacrophage
