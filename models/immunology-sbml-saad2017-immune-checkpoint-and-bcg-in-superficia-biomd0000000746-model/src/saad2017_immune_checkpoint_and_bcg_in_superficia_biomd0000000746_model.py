...
"""Auto-generated SBML BioModule wrapper for Saad2017 - immune checkpoint and BCG in superficial bladder cancer.

Source: biomodels_ebi:BIOMD0000000746
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000746
"""
...
class SbmlSaad2017ImmuneCheckpointAndBcgInSuperficialBladder(biosim.BioModule):
    """BioModule wrapper for SBML model: Saad2017 - immune checkpoint and BCG in superficial bladder cancer."""

    def __init__(self, model_path: str = "data/BIOMD0000000746.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Saad2017ImmuneCheckpointAndBcgInSuperficiaBiomd0000000746Model = SbmlSaad2017ImmuneCheckpointAndBcgInSuperficialBladder
