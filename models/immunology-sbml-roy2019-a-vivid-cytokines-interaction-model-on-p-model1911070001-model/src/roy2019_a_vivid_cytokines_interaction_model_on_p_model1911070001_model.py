...
"""Auto-generated SBML BioModule wrapper for Roy2019 - A vivid cytokines interaction model on psoriasis with the effect of impulse biologic therapy.

Source: biomodels_ebi:MODEL1911070001
Original: https://www.ebi.ac.uk/biomodels/MODEL1911070001
"""
...
class SbmlRoy2019AVividCytokinesInteractionModelOnPsoriasis(biosim.BioModule):
    """BioModule wrapper for SBML model: Roy2019 - A vivid cytokines interaction model on psoriasis with the effect of impulse biologic therapy."""

    def __init__(self, model_path: str = "data/MODEL1911070001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Roy2019AVividCytokinesInteractionModelOnPModel1911070001Model = SbmlRoy2019AVividCytokinesInteractionModelOnPsoriasis
