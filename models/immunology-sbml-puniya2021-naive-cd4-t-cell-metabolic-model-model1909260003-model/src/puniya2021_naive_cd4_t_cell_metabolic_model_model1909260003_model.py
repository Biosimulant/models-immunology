...
"""Auto-generated SBML BioModule wrapper for Puniya2021 - Naive CD4+ T cell metabolic model.

Source: biomodels_ebi:MODEL1909260003
Original: https://www.ebi.ac.uk/biomodels/MODEL1909260003
"""
...
class SbmlPuniya2021NaiveCd4TCellMetabolicModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Puniya2021 - Naive CD4+ T cell metabolic model."""

    def __init__(self, model_path: str = "data/MODEL1909260003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Puniya2021NaiveCd4TCellMetabolicModelModel1909260003Model = SbmlPuniya2021NaiveCd4TCellMetabolicModel
