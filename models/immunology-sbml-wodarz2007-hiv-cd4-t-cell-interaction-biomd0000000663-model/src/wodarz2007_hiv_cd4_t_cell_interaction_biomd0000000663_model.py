...
"""Auto-generated SBML BioModule wrapper for Wodarz2007 - HIV/CD4 T-cell interaction.

Source: biomodels_ebi:BIOMD0000000663
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000663
"""
...
class SbmlWodarz2007HivCd4TCellInteraction(biosim.BioModule):
    """BioModule wrapper for SBML model: Wodarz2007 - HIV/CD4 T-cell interaction."""

    def __init__(self, model_path: str = "data/BIOMD0000000663.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wodarz2007HivCd4TCellInteractionBiomd0000000663Model = SbmlWodarz2007HivCd4TCellInteraction
