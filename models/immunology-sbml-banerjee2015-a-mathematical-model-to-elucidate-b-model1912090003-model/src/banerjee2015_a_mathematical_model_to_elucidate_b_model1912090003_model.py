...
"""Auto-generated SBML BioModule wrapper for Banerjee2015 - A Mathematical Model to Elucidate BrainTumor Abrogation by Immunotherapywith T11 Target Structure.

Source: biomodels_ebi:MODEL1912090003
Original: https://www.ebi.ac.uk/biomodels/MODEL1912090003
"""
...
class SbmlBanerjee2015AMathematicalModelToElucidateBraintumor(biosim.BioModule):
    """BioModule wrapper for SBML model: Banerjee2015 - A Mathematical Model to Elucidate BrainTumor Abrogation by Immunotherapywith T11 Target Structure."""

    def __init__(self, model_path: str = "data/MODEL1912090003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Banerjee2015AMathematicalModelToElucidateBModel1912090003Model = SbmlBanerjee2015AMathematicalModelToElucidateBraintumor
