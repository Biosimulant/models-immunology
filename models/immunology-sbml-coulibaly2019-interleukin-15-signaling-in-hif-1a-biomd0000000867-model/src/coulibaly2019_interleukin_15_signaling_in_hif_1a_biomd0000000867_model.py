...
"""Auto-generated SBML BioModule wrapper for Coulibaly2019 - Interleukin-15 Signaling in HIF-1a Regulation in Natural Killer Cells.

Source: biomodels_ebi:BIOMD0000000867
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000867
"""
...
class SbmlCoulibaly2019Interleukin15SignalingInHif1aRegulation(biosim.BioModule):
    """BioModule wrapper for SBML model: Coulibaly2019 - Interleukin-15 Signaling in HIF-1a Regulation in Natural Killer Cells."""

    def __init__(self, model_path: str = "data/BIOMD0000000867.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Coulibaly2019Interleukin15SignalingInHif1aBiomd0000000867Model = SbmlCoulibaly2019Interleukin15SignalingInHif1aRegulation
