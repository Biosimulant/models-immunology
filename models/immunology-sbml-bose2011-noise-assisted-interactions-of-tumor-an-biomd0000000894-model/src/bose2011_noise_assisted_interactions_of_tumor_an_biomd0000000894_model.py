...
"""Auto-generated SBML BioModule wrapper for Bose2011 - Noise-assisted interactions of tumor and immune cells.

Source: biomodels_ebi:BIOMD0000000894
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000894
"""
...
class SbmlBose2011NoiseAssistedInteractionsOfTumorAndImmune(biosim.BioModule):
    """BioModule wrapper for SBML model: Bose2011 - Noise-assisted interactions of tumor and immune cells."""

    def __init__(self, model_path: str = "data/BIOMD0000000894.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bose2011NoiseAssistedInteractionsOfTumorAnBiomd0000000894Model = SbmlBose2011NoiseAssistedInteractionsOfTumorAndImmune
