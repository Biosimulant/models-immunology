...
"""Auto-generated SBML BioModule wrapper for Schulz2009_Th1_differentiation.

Source: biomodels_ebi:BIOMD0000000215
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000215
"""
...
class SbmlSchulz2009Th1Differentiation(biosim.BioModule):
    """BioModule wrapper for SBML model: Schulz2009_Th1_differentiation."""

    def __init__(self, model_path: str = "data/BIOMD0000000215.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Schulz2009Th1DifferentiationBiomd0000000215Model = SbmlSchulz2009Th1Differentiation
