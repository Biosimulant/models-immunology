...
"""Auto-generated SBML BioModule wrapper for Tsur2019 - Predicting response to pembrolizumab in metastatic melanoma by a new personalization algorithm.

Source: biomodels_ebi:MODEL1911150001
Original: https://www.ebi.ac.uk/biomodels/MODEL1911150001
"""
...
class SbmlTsur2019PredictingResponseToPembrolizumabInMetastatic(biosim.BioModule):
    """BioModule wrapper for SBML model: Tsur2019 - Predicting response to pembrolizumab in metastatic melanoma by a new personalization algorithm."""

    def __init__(self, model_path: str = "data/MODEL1911150001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tsur2019PredictingResponseToPembrolizumabInModel1911150001Model = SbmlTsur2019PredictingResponseToPembrolizumabInMetastatic
