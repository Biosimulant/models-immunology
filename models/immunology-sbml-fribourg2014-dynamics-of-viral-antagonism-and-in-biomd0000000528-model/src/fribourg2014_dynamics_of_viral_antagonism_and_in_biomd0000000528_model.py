...
"""Auto-generated SBML BioModule wrapper for Fribourg2014 - Dynamics of viral antagonism and innate immune response (H1N1 influenza A virus - Cal/09).

Source: biomodels_ebi:BIOMD0000000528
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000528
"""
...
class SbmlFribourg2014DynamicsOfViralAntagonismAndInnateImmune2(biosim.BioModule):
    """BioModule wrapper for SBML model: Fribourg2014 - Dynamics of viral antagonism and innate immune response (H1N1 influenza A virus - Cal/09)."""

    def __init__(self, model_path: str = "data/BIOMD0000000528.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Fribourg2014DynamicsOfViralAntagonismAndInBiomd0000000528Model = SbmlFribourg2014DynamicsOfViralAntagonismAndInnateImmune2
