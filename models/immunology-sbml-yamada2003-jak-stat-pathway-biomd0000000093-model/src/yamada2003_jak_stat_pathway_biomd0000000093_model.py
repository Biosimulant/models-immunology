...
"""Auto-generated SBML BioModule wrapper for Yamada2003_JAK_STAT_pathway.

Source: biomodels_ebi:BIOMD0000000093
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000093
"""
...
class SbmlYamada2003JakStatPathway(biosim.BioModule):
    """BioModule wrapper for SBML model: Yamada2003_JAK_STAT_pathway."""

    def __init__(self, model_path: str = "data/BIOMD0000000093.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Yamada2003JakStatPathwayBiomd0000000093Model = SbmlYamada2003JakStatPathway
