...
"""Auto-generated SBML BioModule wrapper for Eftimie2017/2 - interaction of Th and macrophage in melanoma.

Source: biomodels_ebi:BIOMD0000000769
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000769
"""
...
class SbmlEftimie20172InteractionOfThAndMacrophageInMelanoma(biosim.BioModule):
    """BioModule wrapper for SBML model: Eftimie2017/2 - interaction of Th and macrophage in melanoma."""

    def __init__(self, model_path: str = "data/BIOMD0000000769.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Eftimie20172InteractionOfThAndMacrophageIBiomd0000000769Model = SbmlEftimie20172InteractionOfThAndMacrophageInMelanoma
