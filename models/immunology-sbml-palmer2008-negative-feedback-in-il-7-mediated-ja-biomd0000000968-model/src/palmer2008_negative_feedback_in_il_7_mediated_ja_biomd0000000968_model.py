...
"""Auto-generated SBML BioModule wrapper for Palmer2008 - Negative Feedback in IL-7 mediated Jak-Stat signaling.

Source: biomodels_ebi:BIOMD0000000968
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000968
"""
...
class SbmlPalmer2008NegativeFeedbackInIl7MediatedJakStat(biosim.BioModule):
    """BioModule wrapper for SBML model: Palmer2008 - Negative Feedback in IL-7 mediated Jak-Stat signaling."""

    def __init__(self, model_path: str = "data/BIOMD0000000968.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Palmer2008NegativeFeedbackInIl7MediatedJaBiomd0000000968Model = SbmlPalmer2008NegativeFeedbackInIl7MediatedJakStat
