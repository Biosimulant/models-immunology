...
"""Auto-generated SBML BioModule wrapper for Schokker2013 - A mathematical model representing cellular immune development and response to Salmonella of chicken intestinal tissue.

Source: biomodels_ebi:BIOMD0000000895
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000895
"""
...
class SbmlSchokker2013AMathematicalModelRepresentingCellular(biosim.BioModule):
    """BioModule wrapper for SBML model: Schokker2013 - A mathematical model representing cellular immune development and response to Salmonella of chicken intestinal tissue."""

    def __init__(self, model_path: str = "data/BIOMD0000000895.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Schokker2013AMathematicalModelRepresentingCBiomd0000000895Model = SbmlSchokker2013AMathematicalModelRepresentingCellular
