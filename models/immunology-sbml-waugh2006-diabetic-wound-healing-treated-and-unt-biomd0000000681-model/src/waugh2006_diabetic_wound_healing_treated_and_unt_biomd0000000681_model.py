...
"""Auto-generated SBML BioModule wrapper for Waugh2006 - Diabetic Wound Healing - Treated and Untreated Macrophage Dynamics.

Source: biomodels_ebi:BIOMD0000000681
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000681
"""
...
class SbmlWaugh2006DiabeticWoundHealingTreatedAndUntreated(biosim.BioModule):
    """BioModule wrapper for SBML model: Waugh2006 - Diabetic Wound Healing - Treated and Untreated Macrophage Dynamics."""

    def __init__(self, model_path: str = "data/BIOMD0000000681.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Waugh2006DiabeticWoundHealingTreatedAndUntBiomd0000000681Model = SbmlWaugh2006DiabeticWoundHealingTreatedAndUntreated
