...
"""Auto-generated SBML BioModule wrapper for Scharf2023 - Holistic View on the Structure of Immune Response: Petri Net Model.

Source: biomodels_ebi:MODEL2304260001
Original: https://www.ebi.ac.uk/biomodels/MODEL2304260001
"""
...
class SbmlScharf2023HolisticViewOnTheStructureOfImmune(biosim.BioModule):
    """BioModule wrapper for SBML model: Scharf2023 - Holistic View on the Structure of Immune Response: Petri Net Model."""

    def __init__(self, model_path: str = "data/MODEL2304260001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Scharf2023HolisticViewOnTheStructureOfImmModel2304260001Model = SbmlScharf2023HolisticViewOnTheStructureOfImmune
