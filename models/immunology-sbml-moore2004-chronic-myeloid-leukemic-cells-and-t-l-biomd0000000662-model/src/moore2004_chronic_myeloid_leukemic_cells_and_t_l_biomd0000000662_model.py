...
"""Auto-generated SBML BioModule wrapper for Moore2004 - Chronic Myeloid Leukemic cells and T-lymphocyte interaction.

Source: biomodels_ebi:BIOMD0000000662
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000662
"""
...
class SbmlMoore2004ChronicMyeloidLeukemicCellsAndTLymphocyte(biosim.BioModule):
    """BioModule wrapper for SBML model: Moore2004 - Chronic Myeloid Leukemic cells and T-lymphocyte interaction."""

    def __init__(self, model_path: str = "data/BIOMD0000000662.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Moore2004ChronicMyeloidLeukemicCellsAndTLBiomd0000000662Model = SbmlMoore2004ChronicMyeloidLeukemicCellsAndTLymphocyte
