...
"""Auto-generated SBML BioModule wrapper for Frascoli2014 - A dynamical model of tumour immunotherapy.

Source: biomodels_ebi:BIOMD0000000787
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000787
"""
...
class SbmlFrascoli2014ADynamicalModelOfTumourImmunotherapy(biosim.BioModule):
    """BioModule wrapper for SBML model: Frascoli2014 - A dynamical model of tumour immunotherapy."""

    def __init__(self, model_path: str = "data/BIOMD0000000787.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Frascoli2014ADynamicalModelOfTumourImmunotBiomd0000000787Model = SbmlFrascoli2014ADynamicalModelOfTumourImmunotherapy
