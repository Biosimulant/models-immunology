...
"""Auto-generated SBML BioModule wrapper for Manchanda2014 - Effect on Immune System by 4 different Influenza A virus strains.

Source: biomodels_ebi:BIOMD0000000712
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000712
"""
...
class SbmlManchanda2014EffectOnImmuneSystemBy4Different(biosim.BioModule):
    """BioModule wrapper for SBML model: Manchanda2014 - Effect on Immune System by 4 different Influenza A virus strains."""

    def __init__(self, model_path: str = "data/BIOMD0000000712.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Manchanda2014EffectOnImmuneSystemBy4DiffeBiomd0000000712Model = SbmlManchanda2014EffectOnImmuneSystemBy4Different
