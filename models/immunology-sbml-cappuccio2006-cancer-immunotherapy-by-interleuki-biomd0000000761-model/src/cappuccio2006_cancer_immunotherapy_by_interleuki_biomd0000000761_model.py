...
"""Auto-generated SBML BioModule wrapper for Cappuccio2006 - Cancer immunotherapy by interleukin-21.

Source: biomodels_ebi:BIOMD0000000761
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000761
"""
...
class SbmlCappuccio2006CancerImmunotherapyByInterleukin21(biosim.BioModule):
    """BioModule wrapper for SBML model: Cappuccio2006 - Cancer immunotherapy by interleukin-21."""

    def __init__(self, model_path: str = "data/BIOMD0000000761.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cappuccio2006CancerImmunotherapyByInterleukiBiomd0000000761Model = SbmlCappuccio2006CancerImmunotherapyByInterleukin21
