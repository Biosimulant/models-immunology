...
"""Auto-generated SBML BioModule wrapper for Khajanchi2017 - Uniform Persistence and Global Stability for a Brain Tumor and Immune System Interaction.

Source: biomodels_ebi:BIOMD0000000921
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000921
"""
...
class SbmlKhajanchi2017UniformPersistenceAndGlobalStabilityFor(biosim.BioModule):
    """BioModule wrapper for SBML model: Khajanchi2017 - Uniform Persistence and Global Stability for a Brain Tumor and Immune System Interaction."""

    def __init__(self, model_path: str = "data/BIOMD0000000921.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Khajanchi2017UniformPersistenceAndGlobalStaBiomd0000000921Model = SbmlKhajanchi2017UniformPersistenceAndGlobalStabilityFor
