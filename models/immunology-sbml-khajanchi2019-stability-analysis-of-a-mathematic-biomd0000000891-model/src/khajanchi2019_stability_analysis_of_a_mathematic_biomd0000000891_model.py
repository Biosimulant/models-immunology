...
"""Auto-generated SBML BioModule wrapper for Khajanchi2019 - Stability Analysis of a Mathematical Model forGlioma-Immune Interaction under OptimalTherapy.

Source: biomodels_ebi:BIOMD0000000891
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000891
"""
...
class SbmlKhajanchi2019StabilityAnalysisOfAMathematicalModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Khajanchi2019 - Stability Analysis of a Mathematical Model forGlioma-Immune Interaction under OptimalTherapy."""

    def __init__(self, model_path: str = "data/BIOMD0000000891.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Khajanchi2019StabilityAnalysisOfAMathematicBiomd0000000891Model = SbmlKhajanchi2019StabilityAnalysisOfAMathematicalModel
