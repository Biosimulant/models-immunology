...
"""Auto-generated SBML BioModule wrapper for Dubey2007 - A mathematical model for the effect of toxicant on the immune system (without toxicant effect) Model1.

Source: biomodels_ebi:BIOMD0000000906
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000906
"""
...
class SbmlDubey2007AMathematicalModelForTheEffectOfToxicant2(biosim.BioModule):
    """BioModule wrapper for SBML model: Dubey2007 - A mathematical model for the effect of toxicant on the immune system (without toxicant effect) Model1."""

    def __init__(self, model_path: str = "data/BIOMD0000000906.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dubey2007AMathematicalModelForTheEffectOfBiomd0000000906Model = SbmlDubey2007AMathematicalModelForTheEffectOfToxicant2
