...
"""Auto-generated SBML BioModule wrapper for Feizabadi2011/1 - immunodeficiency in cancer core model.

Source: biomodels_ebi:BIOMD0000000760
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000760
"""
...
class SbmlFeizabadi20111ImmunodeficiencyInCancerCoreModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Feizabadi2011/1 - immunodeficiency in cancer core model."""

    def __init__(self, model_path: str = "data/BIOMD0000000760.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Feizabadi20111ImmunodeficiencyInCancerCoreBiomd0000000760Model = SbmlFeizabadi20111ImmunodeficiencyInCancerCoreModel
