...
"""Auto-generated SBML BioModule wrapper for Leung2016 - SIRWS model with immune boosting and cross-immunity between two pathogens.

Source: biomodels_ebi:MODEL1808280006
Original: https://www.ebi.ac.uk/biomodels/MODEL1808280006
"""
...
class SbmlLeung2016SirwsModelWithImmuneBoostingAndCross(biosim.BioModule):
    """BioModule wrapper for SBML model: Leung2016 - SIRWS model with immune boosting and cross-immunity between two pathogens."""

    def __init__(self, model_path: str = "data/MODEL1808280006.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Leung2016SirwsModelWithImmuneBoostingAndCModel1808280006Model = SbmlLeung2016SirwsModelWithImmuneBoostingAndCross
