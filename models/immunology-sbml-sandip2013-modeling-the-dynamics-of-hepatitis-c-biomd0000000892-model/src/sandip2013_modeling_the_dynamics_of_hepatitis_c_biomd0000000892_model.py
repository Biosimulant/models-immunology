...
"""Auto-generated SBML BioModule wrapper for Sandip2013 - Modeling the dynamics of hepatitis C virus with combined antiviral drug therapy: interferon and ribavirin..

Source: biomodels_ebi:BIOMD0000000892
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000892
"""
...
class SbmlSandip2013ModelingTheDynamicsOfHepatitisCVirusWith2(biosim.BioModule):
    ...
    def __init__(self, model_path: str = "data/BIOMD0000000892.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sandip2013ModelingTheDynamicsOfHepatitisCBiomd0000000892Model = SbmlSandip2013ModelingTheDynamicsOfHepatitisCVirusWith2
