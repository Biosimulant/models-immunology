...
"""Auto-generated SBML BioModule wrapper for Isaeva2008 - Modelling of Anti-Tumour Immune Response Immunocorrective Effect of Weak Centimetre Electromagnetic Waves.

Source: biomodels_ebi:BIOMD0000000910
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000910
"""
...
class SbmlIsaeva2008ModellingOfAntiTumourImmuneResponse(biosim.BioModule):
    """BioModule wrapper for SBML model: Isaeva2008 - Modelling of Anti-Tumour Immune Response Immunocorrective Effect of Weak Centimetre Electromagnetic Waves."""

    def __init__(self, model_path: str = "data/BIOMD0000000910.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Isaeva2008ModellingOfAntiTumourImmuneRespoBiomd0000000910Model = SbmlIsaeva2008ModellingOfAntiTumourImmuneResponse
