...
"""Auto-generated SBML BioModule wrapper for Kilian2024 - Immune cell dynamics in Cue-Induced Extended Human Colitis Model.

Source: biomodels_ebi:MODEL2502180001
Original: https://www.ebi.ac.uk/biomodels/MODEL2502180001
"""
...
class SbmlKilian2024ImmuneCellDynamicsInCueInducedExtended(biosim.BioModule):
    """BioModule wrapper for SBML model: Kilian2024 - Immune cell dynamics in Cue-Induced Extended Human Colitis Model."""

    def __init__(self, model_path: str = "data/MODEL2502180001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kilian2024ImmuneCellDynamicsInCueInducedEModel2502180001Model = SbmlKilian2024ImmuneCellDynamicsInCueInducedExtended
