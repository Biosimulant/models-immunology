...
"""Auto-generated SBML BioModule wrapper for Manda2019 - Acute hepatitis B virus infection model within the host incorporating immune cells and cytokine response.

Source: biomodels_ebi:MODEL1911280002
Original: https://www.ebi.ac.uk/biomodels/MODEL1911280002
"""
...
class SbmlManda2019AcuteHepatitisBVirusInfectionModelWithin(biosim.BioModule):
    """BioModule wrapper for SBML model: Manda2019 - Acute hepatitis B virus infection model within the host incorporating immune cells and cytokine response."""

    def __init__(self, model_path: str = "data/MODEL1911280002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Manda2019AcuteHepatitisBVirusInfectionModeModel1911280002Model = SbmlManda2019AcuteHepatitisBVirusInfectionModelWithin
