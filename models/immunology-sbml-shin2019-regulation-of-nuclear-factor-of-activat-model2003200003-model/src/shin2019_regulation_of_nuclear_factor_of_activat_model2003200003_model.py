...
"""Auto-generated SBML BioModule wrapper for Shin2019- Regulation of nuclear factor of activated T-cells (NFAT).

Source: biomodels_ebi:MODEL2003200003
Original: https://www.ebi.ac.uk/biomodels/MODEL2003200003
"""
...
class SbmlShin2019RegulationOfNuclearFactorOfActivatedTCells2(biosim.BioModule):
    """BioModule wrapper for SBML model: Shin2019- Regulation of nuclear factor of activated T-cells (NFAT)."""

    def __init__(self, model_path: str = "data/MODEL2003200003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Shin2019RegulationOfNuclearFactorOfActivatModel2003200003Model = SbmlShin2019RegulationOfNuclearFactorOfActivatedTCells2
