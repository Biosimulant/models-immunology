...
"""Auto-generated SBML BioModule wrapper for Bianca2012 - Mathematical modeling of the immune system recognition to mammary carcinoma antigen.

Source: biomodels_ebi:MODEL1907260002
Original: https://www.ebi.ac.uk/biomodels/MODEL1907260002
"""
...
class SbmlBianca2012MathematicalModelingOfTheImmuneSystem(biosim.BioModule):
    """BioModule wrapper for SBML model: Bianca2012 - Mathematical modeling of the immune system recognition to mammary carcinoma antigen."""

    def __init__(self, model_path: str = "data/MODEL1907260002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bianca2012MathematicalModelingOfTheImmuneSModel1907260002Model = SbmlBianca2012MathematicalModelingOfTheImmuneSystem
