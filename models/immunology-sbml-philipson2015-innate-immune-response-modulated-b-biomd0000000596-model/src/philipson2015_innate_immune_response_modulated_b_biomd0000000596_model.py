...
"""Auto-generated SBML BioModule wrapper for Philipson2015 - Innate immune response modulated by NLRX1.

Source: biomodels_ebi:BIOMD0000000596
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000596
"""
...
class SbmlPhilipson2015InnateImmuneResponseModulatedByNlrx1(biosim.BioModule):
    """BioModule wrapper for SBML model: Philipson2015 - Innate immune response modulated by NLRX1."""

    def __init__(self, model_path: str = "data/BIOMD0000000596.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Philipson2015InnateImmuneResponseModulatedBBiomd0000000596Model = SbmlPhilipson2015InnateImmuneResponseModulatedByNlrx1
