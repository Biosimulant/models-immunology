...
**Source**: [biomodels_ebi](https://www.ebi.ac.uk/biomodels/MODEL1203220000)
**Standard**: sbml
...
models:
  - path: ../../models/immunology-sbml-mol2013-leishmania-macrophage-signaling-network-model1203220000-model
    alias: model
```
