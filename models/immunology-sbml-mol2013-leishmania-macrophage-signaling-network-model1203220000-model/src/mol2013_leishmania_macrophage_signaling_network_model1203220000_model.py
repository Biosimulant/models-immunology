...
"""Auto-generated SBML BioModule wrapper for Mol2013 - Leishmania macrophage signaling network.

Source: biomodels_ebi:MODEL1203220000
Original: https://www.ebi.ac.uk/biomodels/MODEL1203220000
"""
...
class SbmlMol2013LeishmaniaMacrophageSignalingNetwork(biosim.BioModule):
    """BioModule wrapper for SBML model: Mol2013 - Leishmania macrophage signaling network."""

    def __init__(self, model_path: str = "data/MODEL1203220000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mol2013LeishmaniaMacrophageSignalingNetworkModel1203220000Model = SbmlMol2013LeishmaniaMacrophageSignalingNetwork
