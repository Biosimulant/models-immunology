...
"""Auto-generated SBML BioModule wrapper for Macnamara2015/2 - virotherapy virus-free submodel.

Source: biomodels_ebi:BIOMD0000000767
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000767
"""
...
class SbmlMacnamara20152VirotherapyVirusFreeSubmodel(biosim.BioModule):
    """BioModule wrapper for SBML model: Macnamara2015/2 - virotherapy virus-free submodel."""

    def __init__(self, model_path: str = "data/BIOMD0000000767.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Macnamara20152VirotherapyVirusFreeSubmodelBiomd0000000767Model = SbmlMacnamara20152VirotherapyVirusFreeSubmodel
