...
"""Auto-generated SBML BioModule wrapper for Rodríguez-Jorge2019 - Boolean model of TLR5 signaling for CD4 + T cell activation.

Source: biomodels_ebi:MODEL1903260002
Original: https://www.ebi.ac.uk/biomodels/MODEL1903260002
"""
...
class SbmlRodriguezJorge2019BooleanModelOfTlr5SignalingForCd4(biosim.BioModule):
    """BioModule wrapper for SBML model: Rodríguez-Jorge2019 - Boolean model of TLR5 signaling for CD4 + T cell activation."""

    def __init__(self, model_path: str = "data/MODEL1903260002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
RodrGuezJorge2019BooleanModelOfTlr5SignalModel1903260002Model = SbmlRodriguezJorge2019BooleanModelOfTlr5SignalingForCd4
