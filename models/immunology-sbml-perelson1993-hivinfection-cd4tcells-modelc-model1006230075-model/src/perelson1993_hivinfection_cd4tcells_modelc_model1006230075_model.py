...
"""Auto-generated SBML BioModule wrapper for Perelson1993_HIVinfection_CD4Tcells_ModelC.

Source: biomodels_ebi:MODEL1006230075
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230075
"""
...
class SbmlPerelson1993HivinfectionCd4tcellsModelc(biosim.BioModule):
    """BioModule wrapper for SBML model: Perelson1993_HIVinfection_CD4Tcells_ModelC."""

    def __init__(self, model_path: str = "data/MODEL1006230075.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Perelson1993HivinfectionCd4tcellsModelcModel1006230075Model = SbmlPerelson1993HivinfectionCd4tcellsModelc
