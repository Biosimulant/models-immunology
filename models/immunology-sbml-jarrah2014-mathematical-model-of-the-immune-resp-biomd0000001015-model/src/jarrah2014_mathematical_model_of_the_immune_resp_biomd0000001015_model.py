...
"""Auto-generated SBML BioModule wrapper for Jarrah2014 - mathematical model of the immune response in muscle degeneration and subsequent regeneration in Duchenne muscular dystrophy in mdx mice.

Source: biomodels_ebi:BIOMD0000001015
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001015
"""
...
class SbmlJarrah2014MathematicalModelOfTheImmuneResponseIn(biosim.BioModule):
    """BioModule wrapper for SBML model: Jarrah2014 - mathematical model of the immune response in muscle degeneration and subsequent regeneration in Duchenne muscular dystrophy in mdx mice."""

    def __init__(self, model_path: str = "data/BIOMD0000001015.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Jarrah2014MathematicalModelOfTheImmuneRespBiomd0000001015Model = SbmlJarrah2014MathematicalModelOfTheImmuneResponseIn
