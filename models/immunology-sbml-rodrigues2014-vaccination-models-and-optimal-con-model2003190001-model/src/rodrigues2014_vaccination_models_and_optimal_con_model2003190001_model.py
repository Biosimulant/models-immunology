...
"""Auto-generated SBML BioModule wrapper for Rodrigues2014-Vaccination models and optimal control strategies to dengue.

Source: biomodels_ebi:MODEL2003190001
Original: https://www.ebi.ac.uk/biomodels/MODEL2003190001
"""
...
class SbmlRodrigues2014VaccinationModelsAndOptimalControl(biosim.BioModule):
    """BioModule wrapper for SBML model: Rodrigues2014-Vaccination models and optimal control strategies to dengue."""

    def __init__(self, model_path: str = "data/MODEL2003190001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rodrigues2014VaccinationModelsAndOptimalConModel2003190001Model = SbmlRodrigues2014VaccinationModelsAndOptimalControl
