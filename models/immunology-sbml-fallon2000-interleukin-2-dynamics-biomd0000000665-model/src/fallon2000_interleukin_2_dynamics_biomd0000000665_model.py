...
"""Auto-generated SBML BioModule wrapper for Fallon2000 - Interleukin-2 dynamics.

Source: biomodels_ebi:BIOMD0000000665
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000665
"""
...
class SbmlFallon2000Interleukin2Dynamics(biosim.BioModule):
    """BioModule wrapper for SBML model: Fallon2000 - Interleukin-2 dynamics."""

    def __init__(self, model_path: str = "data/BIOMD0000000665.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Fallon2000Interleukin2DynamicsBiomd0000000665Model = SbmlFallon2000Interleukin2Dynamics
