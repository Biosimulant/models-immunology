...
"""Auto-generated SBML BioModule wrapper for Rodríguez-Jorge2019 - Boolean model of combined TCR and TLR5 signaling for CD4 + T cell activation.

Source: biomodels_ebi:MODEL1903260003
Original: https://www.ebi.ac.uk/biomodels/MODEL1903260003
"""
...
class SbmlRodriguezJorge2019BooleanModelOfCombinedTcrAndTlr5(biosim.BioModule):
    """BioModule wrapper for SBML model: Rodríguez-Jorge2019 - Boolean model of combined TCR and TLR5 signaling for CD4 + T cell activation."""

    def __init__(self, model_path: str = "data/MODEL1903260003.sbml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
RodrGuezJorge2019BooleanModelOfCombinedTcModel1903260003Model = SbmlRodriguezJorge2019BooleanModelOfCombinedTcrAndTlr5
