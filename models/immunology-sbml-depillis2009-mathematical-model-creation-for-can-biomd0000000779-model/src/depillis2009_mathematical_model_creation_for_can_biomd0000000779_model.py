...
"""Auto-generated SBML BioModule wrapper for dePillis2009 - Mathematical model creation for cancer chemo-immunotherapy.

Source: biomodels_ebi:BIOMD0000000779
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000779
"""
...
class SbmlDepillis2009MathematicalModelCreationForCancerChemo(biosim.BioModule):
    """BioModule wrapper for SBML model: dePillis2009 - Mathematical model creation for cancer chemo-immunotherapy."""

    def __init__(self, model_path: str = "data/BIOMD0000000779.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Depillis2009MathematicalModelCreationForCanBiomd0000000779Model = SbmlDepillis2009MathematicalModelCreationForCancerChemo
