...
"""Auto-generated SBML BioModule wrapper for Macnamara2015/1 - virotherapy full model.

Source: biomodels_ebi:BIOMD0000000766
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000766
"""
...
class SbmlMacnamara20151VirotherapyFullModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Macnamara2015/1 - virotherapy full model."""

    def __init__(self, model_path: str = "data/BIOMD0000000766.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Macnamara20151VirotherapyFullModelBiomd0000000766Model = SbmlMacnamara20151VirotherapyFullModel
