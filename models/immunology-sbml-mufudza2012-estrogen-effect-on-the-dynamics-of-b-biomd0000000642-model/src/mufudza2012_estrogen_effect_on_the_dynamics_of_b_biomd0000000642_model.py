...
"""Auto-generated SBML BioModule wrapper for Mufudza2012 - Estrogen effect on the dynamics of breast cancer.

Source: biomodels_ebi:BIOMD0000000642
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000642
"""
...
class SbmlMufudza2012EstrogenEffectOnTheDynamicsOfBreastCancer(biosim.BioModule):
    """BioModule wrapper for SBML model: Mufudza2012 - Estrogen effect on the dynamics of breast cancer."""

    def __init__(self, model_path: str = "data/BIOMD0000000642.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mufudza2012EstrogenEffectOnTheDynamicsOfBBiomd0000000642Model = SbmlMufudza2012EstrogenEffectOnTheDynamicsOfBreastCancer
