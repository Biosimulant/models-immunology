...
"""Auto-generated SBML BioModule wrapper for Dubey2007 - A mathematical model for the effect of toxicant on the immune system (with toxicant effect) Model2.

Source: biomodels_ebi:BIOMD0000000905
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000905
"""
...
class SbmlDubey2007AMathematicalModelForTheEffectOfToxicant(biosim.BioModule):
    """BioModule wrapper for SBML model: Dubey2007 - A mathematical model for the effect of toxicant on the immune system (with toxicant effect) Model2."""

    def __init__(self, model_path: str = "data/BIOMD0000000905.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dubey2007AMathematicalModelForTheEffectOfBiomd0000000905Model = SbmlDubey2007AMathematicalModelForTheEffectOfToxicant
