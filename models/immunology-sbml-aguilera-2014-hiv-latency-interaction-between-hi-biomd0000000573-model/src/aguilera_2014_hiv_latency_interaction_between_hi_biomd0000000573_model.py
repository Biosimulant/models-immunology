...
"""Auto-generated SBML BioModule wrapper for Aguilera 2014 - HIV latency. Interaction between HIV proteins and immune response.

Source: biomodels_ebi:BIOMD0000000573
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000573
"""
...
class SbmlAguilera2014HivLatencyInteractionBetweenHivProteins(biosim.BioModule):
    """BioModule wrapper for SBML model: Aguilera 2014 - HIV latency. Interaction between HIV proteins and immune response."""

    def __init__(self, model_path: str = "data/BIOMD0000000573.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Aguilera2014HivLatencyInteractionBetweenHiBiomd0000000573Model = SbmlAguilera2014HivLatencyInteractionBetweenHivProteins
