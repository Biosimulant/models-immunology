...
"""Auto-generated SBML BioModule wrapper for Makhlouf2020 - No treatment model of the role of CD4 T cells in tumor-immune interactions.

Source: biomodels_ebi:BIOMD0000001042
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001042
"""
...
class SbmlMakhlouf2020NoTreatmentModelOfTheRoleOfCd4TCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Makhlouf2020 - No treatment model of the role of CD4 T cells in tumor-immune interactions."""

    def __init__(self, model_path: str = "data/BIOMD0000001042.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Makhlouf2020NoTreatmentModelOfTheRoleOfCBiomd0000001042Model = SbmlMakhlouf2020NoTreatmentModelOfTheRoleOfCd4TCells
