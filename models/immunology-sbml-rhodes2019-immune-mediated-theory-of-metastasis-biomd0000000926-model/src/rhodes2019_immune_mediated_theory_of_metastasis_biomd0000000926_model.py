...
"""Auto-generated SBML BioModule wrapper for Rhodes2019 - Immune-Mediated theory of Metastasis.

Source: biomodels_ebi:BIOMD0000000926
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000926
"""
...
class SbmlRhodes2019ImmuneMediatedTheoryOfMetastasis(biosim.BioModule):
    """BioModule wrapper for SBML model: Rhodes2019 - Immune-Mediated theory of Metastasis."""

    def __init__(self, model_path: str = "data/BIOMD0000000926.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rhodes2019ImmuneMediatedTheoryOfMetastasisBiomd0000000926Model = SbmlRhodes2019ImmuneMediatedTheoryOfMetastasis
