...
"""Auto-generated SBML BioModule wrapper for Diego2021 - Improved Prediction of ICB Efficacy Across Multiple Cancer Types using Random Forests.

Source: biomodels_ebi:MODEL2407210002
Original: https://www.ebi.ac.uk/biomodels/MODEL2407210002
"""
...
class SbmlDiego2021ImprovedPredictionOfIcbEfficacyAcross(biosim.BioModule):
    """BioModule wrapper for SBML model: Diego2021 - Improved Prediction of ICB Efficacy Across Multiple Cancer Types using Random Forests."""

    def __init__(self, model_path: str = "data/MODEL2407210002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Diego2021ImprovedPredictionOfIcbEfficacyAcModel2407210002Model = SbmlDiego2021ImprovedPredictionOfIcbEfficacyAcross
