...
"""Auto-generated SBML BioModule wrapper for Ganguli2018-immuno regulatory mechanisms in tumor microenvironment.

Source: biomodels_ebi:BIOMD0000000810
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000810
"""
...
class SbmlGanguli2018ImmunoRegulatoryMechanismsInTumor(biosim.BioModule):
    """BioModule wrapper for SBML model: Ganguli2018-immuno regulatory mechanisms in tumor microenvironment."""

    def __init__(self, model_path: str = "data/BIOMD0000000810.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ganguli2018ImmunoRegulatoryMechanismsInTumoBiomd0000000810Model = SbmlGanguli2018ImmunoRegulatoryMechanismsInTumor
