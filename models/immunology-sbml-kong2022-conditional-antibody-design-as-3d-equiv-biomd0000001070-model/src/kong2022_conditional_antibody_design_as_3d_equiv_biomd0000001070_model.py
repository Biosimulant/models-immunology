...
"""Auto-generated SBML BioModule wrapper for Kong2022 - Conditional Antibody Design as 3D Equivariant Graph Translation.

Source: biomodels_ebi:BIOMD0000001070
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001070
"""
...
class SbmlKong2022ConditionalAntibodyDesignAs3dEquivariant(biosim.BioModule):
    """BioModule wrapper for SBML model: Kong2022 - Conditional Antibody Design as 3D Equivariant Graph Translation."""

    def __init__(self, model_path: str = "data/BIOMD0000001070.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kong2022ConditionalAntibodyDesignAs3dEquivBiomd0000001070Model = SbmlKong2022ConditionalAntibodyDesignAs3dEquivariant
