...
"""Auto-generated tests for Kong2022ConditionalAntibodyDesignAs3dEquivBiomd0000001070Model.
...
from src.kong2022_conditional_antibody_design_as_3d_equiv_biomd0000001070_model import Kong2022ConditionalAntibodyDesignAs3dEquivBiomd0000001070Model  # noqa: E402
from bsim.signals import BioSignal  # noqa: E402


def test_instantiation() -> None:
    module = Kong2022ConditionalAntibodyDesignAs3dEquivBiomd0000001070Model()
...
def test_advance_produces_outputs() -> None:
    module = Kong2022ConditionalAntibodyDesignAs3dEquivBiomd0000001070Model(min_dt=0.1)
