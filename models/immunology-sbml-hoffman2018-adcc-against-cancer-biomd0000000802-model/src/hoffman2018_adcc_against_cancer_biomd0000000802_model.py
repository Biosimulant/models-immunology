...
"""Auto-generated SBML BioModule wrapper for Hoffman2018- ADCC against cancer.

Source: biomodels_ebi:BIOMD0000000802
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000802
"""
...
class SbmlHoffman2018AdccAgainstCancer(biosim.BioModule):
    """BioModule wrapper for SBML model: Hoffman2018- ADCC against cancer."""

    def __init__(self, model_path: str = "data/BIOMD0000000802.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hoffman2018AdccAgainstCancerBiomd0000000802Model = SbmlHoffman2018AdccAgainstCancer
