...
"""Auto-generated SBML BioModule wrapper for Immunological Healthy State Model of Sphingolipids with IL-6/IL-17/IL-23 immune axis in L.major infection.

Source: biomodels_ebi:MODEL2301110002
Original: https://www.ebi.ac.uk/biomodels/MODEL2301110002
"""
...
class SbmlImmunologicalHealthyStateModelOfSphingolipidsWithIl(biosim.BioModule):
    """BioModule wrapper for SBML model: Immunological Healthy State Model of Sphingolipids with IL-6/IL-17/IL-23 immune axis in L.major infection."""

    def __init__(self, model_path: str = "data/MODEL2301110002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ImmunologicalHealthyStateModelOfSphingolipiModel2301110002Model = SbmlImmunologicalHealthyStateModelOfSphingolipidsWithIl
