...
"""Auto-generated SBML BioModule wrapper for Theinmozhi2018 - Mechanism of PD1 inhibiting TCR signaling in Tumor immune regulation.

Source: biomodels_ebi:BIOMD0000000724
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000724
"""
...
class SbmlTheinmozhi2018MechanismOfPd1InhibitingTcrSignalingIn(biosim.BioModule):
    """BioModule wrapper for SBML model: Theinmozhi2018 - Mechanism of PD1 inhibiting TCR signaling in Tumor immune regulation."""

    def __init__(self, model_path: str = "data/BIOMD0000000724.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Theinmozhi2018MechanismOfPd1InhibitingTcrSBiomd0000000724Model = SbmlTheinmozhi2018MechanismOfPd1InhibitingTcrSignalingIn
