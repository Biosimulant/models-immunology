...
"""Auto-generated SBML BioModule wrapper for Kim2014 - Tumor model under immune suppression.

Source: biomodels_ebi:MODEL1909240002
Original: https://www.ebi.ac.uk/biomodels/MODEL1909240002
"""
...
class SbmlKim2014TumorModelUnderImmuneSuppression(biosim.BioModule):
    """BioModule wrapper for SBML model: Kim2014 - Tumor model under immune suppression."""

    def __init__(self, model_path: str = "data/MODEL1909240002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kim2014TumorModelUnderImmuneSuppressionModel1909240002Model = SbmlKim2014TumorModelUnderImmuneSuppression
