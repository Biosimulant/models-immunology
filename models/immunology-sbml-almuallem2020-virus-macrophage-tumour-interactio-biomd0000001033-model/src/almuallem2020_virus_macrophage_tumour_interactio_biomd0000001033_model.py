...
"""Auto-generated SBML BioModule wrapper for Almuallem2020 - Virus-macrophage-tumour interactions in oncolytic viral therapies.

Source: biomodels_ebi:BIOMD0000001033
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001033
"""
...
class SbmlAlmuallem2020VirusMacrophageTumourInteractionsIn(biosim.BioModule):
    """BioModule wrapper for SBML model: Almuallem2020 - Virus-macrophage-tumour interactions in oncolytic viral therapies."""

    def __init__(self, model_path: str = "data/BIOMD0000001033.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Almuallem2020VirusMacrophageTumourInteractioBiomd0000001033Model = SbmlAlmuallem2020VirusMacrophageTumourInteractionsIn
