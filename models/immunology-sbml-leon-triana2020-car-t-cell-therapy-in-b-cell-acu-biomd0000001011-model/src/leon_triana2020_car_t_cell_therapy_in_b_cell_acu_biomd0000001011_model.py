...
"""Auto-generated SBML BioModule wrapper for Leon-Triana2020 - CAR T-cell therapy in B-cell acute lymphoblastic leukaemia.

Source: biomodels_ebi:BIOMD0000001011
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001011
"""
...
class SbmlLeonTriana2020CarTCellTherapyInBCellAcute(biosim.BioModule):
    """BioModule wrapper for SBML model: Leon-Triana2020 - CAR T-cell therapy in B-cell acute lymphoblastic leukaemia."""

    def __init__(self, model_path: str = "data/BIOMD0000001011.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
LeonTriana2020CarTCellTherapyInBCellAcuBiomd0000001011Model = SbmlLeonTriana2020CarTCellTherapyInBCellAcute
