...
"""Auto-generated SBML BioModule wrapper for Wei2017 - tumor, T cell and cytokine interaction.

Source: biomodels_ebi:BIOMD0000000778
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000778
"""
...
class SbmlWei2017TumorTCellAndCytokineInteraction(biosim.BioModule):
    """BioModule wrapper for SBML model: Wei2017 - tumor, T cell and cytokine interaction."""

    def __init__(self, model_path: str = "data/BIOMD0000000778.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wei2017TumorTCellAndCytokineInteractionBiomd0000000778Model = SbmlWei2017TumorTCellAndCytokineInteraction
