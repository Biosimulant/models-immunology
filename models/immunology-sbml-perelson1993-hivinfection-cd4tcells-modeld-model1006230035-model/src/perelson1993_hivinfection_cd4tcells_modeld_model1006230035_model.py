...
"""Auto-generated SBML BioModule wrapper for Perelson1993_HIVinfection_CD4Tcells_ModelD.

Source: biomodels_ebi:MODEL1006230035
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230035
"""
...
class SbmlPerelson1993HivinfectionCd4tcellsModeld(biosim.BioModule):
    """BioModule wrapper for SBML model: Perelson1993_HIVinfection_CD4Tcells_ModelD."""

    def __init__(self, model_path: str = "data/MODEL1006230035.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Perelson1993HivinfectionCd4tcellsModeldModel1006230035Model = SbmlPerelson1993HivinfectionCd4tcellsModeld
