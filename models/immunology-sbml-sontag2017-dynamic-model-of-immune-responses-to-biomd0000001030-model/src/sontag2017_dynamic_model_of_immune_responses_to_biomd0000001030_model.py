...
"""Auto-generated SBML BioModule wrapper for Sontag2017 - Dynamic model of immune responses to antigen presentation by tumor or pathogen.

Source: biomodels_ebi:BIOMD0000001030
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001030
"""
...
class SbmlSontag2017DynamicModelOfImmuneResponsesToAntigen(biosim.BioModule):
    """BioModule wrapper for SBML model: Sontag2017 - Dynamic model of immune responses to antigen presentation by tumor or pathogen."""

    def __init__(self, model_path: str = "data/BIOMD0000001030.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sontag2017DynamicModelOfImmuneResponsesToBiomd0000001030Model = SbmlSontag2017DynamicModelOfImmuneResponsesToAntigen
