...
"""Auto-generated SBML BioModule wrapper for Baker2013 - Cytokine Mediated Inflammation in Rheumatoid Arthritis - Age Dependent.

Source: biomodels_ebi:BIOMD0000000549
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000549
"""
...
class SbmlBaker2013CytokineMediatedInflammationInRheumatoid2(biosim.BioModule):
    """BioModule wrapper for SBML model: Baker2013 - Cytokine Mediated Inflammation in Rheumatoid Arthritis - Age Dependent."""

    def __init__(self, model_path: str = "data/BIOMD0000000549.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Baker2013CytokineMediatedInflammationInRheuBiomd0000000549Model = SbmlBaker2013CytokineMediatedInflammationInRheumatoid2
