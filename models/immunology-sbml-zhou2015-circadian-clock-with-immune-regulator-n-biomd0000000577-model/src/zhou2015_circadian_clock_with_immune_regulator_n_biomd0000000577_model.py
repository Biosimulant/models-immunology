...
"""Auto-generated SBML BioModule wrapper for Zhou2015 - Circadian clock with immune regulator NPR1.

Source: biomodels_ebi:BIOMD0000000577
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000577
"""
...
class SbmlZhou2015CircadianClockWithImmuneRegulatorNpr1(biosim.BioModule):
    """BioModule wrapper for SBML model: Zhou2015 - Circadian clock with immune regulator NPR1."""

    def __init__(self, model_path: str = "data/BIOMD0000000577.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zhou2015CircadianClockWithImmuneRegulatorNBiomd0000000577Model = SbmlZhou2015CircadianClockWithImmuneRegulatorNpr1
