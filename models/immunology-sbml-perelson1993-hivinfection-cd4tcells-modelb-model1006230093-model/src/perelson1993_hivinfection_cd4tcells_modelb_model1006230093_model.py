...
"""Auto-generated SBML BioModule wrapper for Perelson1993_HIVinfection_CD4Tcells_ModelB.

Source: biomodels_ebi:MODEL1006230093
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230093
"""
...
class SbmlPerelson1993HivinfectionCd4tcellsModelb(biosim.BioModule):
    """BioModule wrapper for SBML model: Perelson1993_HIVinfection_CD4Tcells_ModelB."""

    def __init__(self, model_path: str = "data/MODEL1006230093.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Perelson1993HivinfectionCd4tcellsModelbModel1006230093Model = SbmlPerelson1993HivinfectionCd4tcellsModelb
