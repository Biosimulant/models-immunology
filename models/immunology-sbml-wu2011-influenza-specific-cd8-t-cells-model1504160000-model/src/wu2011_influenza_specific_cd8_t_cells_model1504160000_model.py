...
"""Auto-generated SBML BioModule wrapper for Wu2011 - Influenza-specific CD8+ T cells.

Source: biomodels_ebi:MODEL1504160000
Original: https://www.ebi.ac.uk/biomodels/MODEL1504160000
"""
...
class SbmlWu2011InfluenzaSpecificCd8TCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Wu2011 - Influenza-specific CD8+ T cells."""

    def __init__(self, model_path: str = "data/MODEL1504160000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wu2011InfluenzaSpecificCd8TCellsModel1504160000Model = SbmlWu2011InfluenzaSpecificCd8TCells
