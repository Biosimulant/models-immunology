...
"""Auto-generated SBML BioModule wrapper for Bachmann2011 - Division of labor by dual feedback regulators controls JAK2/STAT5 signaling over broad ligand range.

Source: biomodels_ebi:BIOMD0000000861
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000861
"""
...
class SbmlBachmann2011DivisionOfLaborByDualFeedbackRegulators(biosim.BioModule):
    """BioModule wrapper for SBML model: Bachmann2011 - Division of labor by dual feedback regulators controls JAK2/STAT5 signaling over broad ligand range."""

    def __init__(self, model_path: str = "data/BIOMD0000000861.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bachmann2011DivisionOfLaborByDualFeedbackBiomd0000000861Model = SbmlBachmann2011DivisionOfLaborByDualFeedbackRegulators
