...
"""Auto-generated SBML BioModule wrapper for Chrobak2011 - A mathematical model of induced cancer-adaptive immune system competition.

Source: biomodels_ebi:BIOMD0000000815
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000815
"""
...
class SbmlChrobak2011AMathematicalModelOfInducedCancerAdaptive(biosim.BioModule):
    """BioModule wrapper for SBML model: Chrobak2011 - A mathematical model of induced cancer-adaptive immune system competition."""

    def __init__(self, model_path: str = "data/BIOMD0000000815.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chrobak2011AMathematicalModelOfInducedCancBiomd0000000815Model = SbmlChrobak2011AMathematicalModelOfInducedCancerAdaptive
