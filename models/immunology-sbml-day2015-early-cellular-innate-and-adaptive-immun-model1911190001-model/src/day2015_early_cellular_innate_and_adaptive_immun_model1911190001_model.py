...
"""Auto-generated SBML BioModule wrapper for Day2015 - Early cellular innate and adaptive immune responses to ischemia/reperfusion injury and solid organ allotransplantation.

Source: biomodels_ebi:MODEL1911190001
Original: https://www.ebi.ac.uk/biomodels/MODEL1911190001
"""
...
class SbmlDay2015EarlyCellularInnateAndAdaptiveImmuneResponses(biosim.BioModule):
    """BioModule wrapper for SBML model: Day2015 - Early cellular innate and adaptive immune responses to ischemia/reperfusion injury and solid organ allotransplantation."""

    def __init__(self, model_path: str = "data/MODEL1911190001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Day2015EarlyCellularInnateAndAdaptiveImmunModel1911190001Model = SbmlDay2015EarlyCellularInnateAndAdaptiveImmuneResponses
