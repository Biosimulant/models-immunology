...
"""Auto-generated SBML BioModule wrapper for Aavani2019 - The role of CD4 T cells in immune system activation and viral reproduction in a simple model for HIV infection.

Source: biomodels_ebi:BIOMD0000000876
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000876
"""
...
class SbmlAavani2019TheRoleOfCd4TCellsInImmuneSystem(biosim.BioModule):
    """BioModule wrapper for SBML model: Aavani2019 - The role of CD4 T cells in immune system activation and viral reproduction in a simple model for HIV infection."""

    def __init__(self, model_path: str = "data/BIOMD0000000876.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Aavani2019TheRoleOfCd4TCellsInImmuneSysBiomd0000000876Model = SbmlAavani2019TheRoleOfCd4TCellsInImmuneSystem
