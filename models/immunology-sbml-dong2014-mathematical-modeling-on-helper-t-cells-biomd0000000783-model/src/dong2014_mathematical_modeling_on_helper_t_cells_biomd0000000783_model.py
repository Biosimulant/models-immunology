...
"""Auto-generated SBML BioModule wrapper for Dong2014 - Mathematical modeling on helper t cells in a tumor immune system.

Source: biomodels_ebi:BIOMD0000000783
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000783
"""
...
class SbmlDong2014MathematicalModelingOnHelperTCellsInATumor(biosim.BioModule):
    """BioModule wrapper for SBML model: Dong2014 - Mathematical modeling on helper t cells in a tumor immune system."""

    def __init__(self, model_path: str = "data/BIOMD0000000783.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dong2014MathematicalModelingOnHelperTCellsBiomd0000000783Model = SbmlDong2014MathematicalModelingOnHelperTCellsInATumor
