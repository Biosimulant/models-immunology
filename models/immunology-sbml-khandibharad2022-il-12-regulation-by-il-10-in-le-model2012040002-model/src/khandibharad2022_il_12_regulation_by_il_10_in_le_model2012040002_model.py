...
"""Auto-generated SBML BioModule wrapper for Khandibharad2022 - IL-12 regulation by IL-10 in Leishmaniasis.

Source: biomodels_ebi:MODEL2012040002
Original: https://www.ebi.ac.uk/biomodels/MODEL2012040002
"""
...
class SbmlKhandibharad2022Il12RegulationByIl10InLeishmaniasis(biosim.BioModule):
    """BioModule wrapper for SBML model: Khandibharad2022 - IL-12 regulation by IL-10 in Leishmaniasis."""

    def __init__(self, model_path: str = "data/MODEL2012040002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Khandibharad2022Il12RegulationByIl10InLeModel2012040002Model = SbmlKhandibharad2022Il12RegulationByIl10InLeishmaniasis
