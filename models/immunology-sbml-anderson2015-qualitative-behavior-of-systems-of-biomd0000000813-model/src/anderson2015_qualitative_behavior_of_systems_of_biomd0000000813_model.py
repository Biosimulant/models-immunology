...
"""Auto-generated SBML BioModule wrapper for Anderson2015 - Qualitative behavior of systems of tumor-CD4+-cytokine interactions with treatments.

Source: biomodels_ebi:BIOMD0000000813
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000813
"""
...
class SbmlAnderson2015QualitativeBehaviorOfSystemsOfTumorCd4(biosim.BioModule):
    """BioModule wrapper for SBML model: Anderson2015 - Qualitative behavior of systems of tumor-CD4+-cytokine interactions with treatments."""

    def __init__(self, model_path: str = "data/BIOMD0000000813.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Anderson2015QualitativeBehaviorOfSystemsOfBiomd0000000813Model = SbmlAnderson2015QualitativeBehaviorOfSystemsOfTumorCd4
