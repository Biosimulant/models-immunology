...
"""Auto-generated SBML BioModule wrapper for Yu2019 - A mathematical model of tumor-immune interactions with an immune checkpoint inhibitor.

Source: biomodels_ebi:MODEL1911270002
Original: https://www.ebi.ac.uk/biomodels/MODEL1911270002
"""
...
class SbmlYu2019AMathematicalModelOfTumorImmuneInteractions(biosim.BioModule):
    """BioModule wrapper for SBML model: Yu2019 - A mathematical model of tumor-immune interactions with an immune checkpoint inhibitor."""

    def __init__(self, model_path: str = "data/MODEL1911270002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Yu2019AMathematicalModelOfTumorImmuneInteModel1911270002Model = SbmlYu2019AMathematicalModelOfTumorImmuneInteractions
