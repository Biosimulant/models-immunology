...
"""Auto-generated SBML BioModule wrapper for Nanda2013 - B cell chronic lymphocytic leukemia A model with immune response.

Source: biomodels_ebi:MODEL2001090002
Original: https://www.ebi.ac.uk/biomodels/MODEL2001090002
"""
...
class SbmlNanda2013BCellChronicLymphocyticLeukemiaAModelWith(biosim.BioModule):
    """BioModule wrapper for SBML model: Nanda2013 - B cell chronic lymphocytic leukemia A model with immune response."""

    def __init__(self, model_path: str = "data/MODEL2001090002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nanda2013BCellChronicLymphocyticLeukemiaAModel2001090002Model = SbmlNanda2013BCellChronicLymphocyticLeukemiaAModelWith
