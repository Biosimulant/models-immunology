...
"""Auto-generated SBML BioModule wrapper for Baker(2022) - Immunometabolic Model.

Source: biomodels_ebi:MODEL2211070001
Original: https://www.ebi.ac.uk/biomodels/MODEL2211070001
"""
...
class SbmlBaker2022ImmunometabolicModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Baker(2022) - Immunometabolic Model."""

    def __init__(self, model_path: str = "data/MODEL2211070001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Baker2022ImmunometabolicModelModel2211070001Model = SbmlBaker2022ImmunometabolicModel
