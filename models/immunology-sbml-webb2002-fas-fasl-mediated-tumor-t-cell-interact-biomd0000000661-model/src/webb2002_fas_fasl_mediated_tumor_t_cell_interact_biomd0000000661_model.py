...
"""Auto-generated SBML BioModule wrapper for Webb2002 - Fas/FasL mediated tumor T-cell interaction.

Source: biomodels_ebi:BIOMD0000000661
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000661
"""
...
class SbmlWebb2002FasFaslMediatedTumorTCellInteraction(biosim.BioModule):
    """BioModule wrapper for SBML model: Webb2002 - Fas/FasL mediated tumor T-cell interaction."""

    def __init__(self, model_path: str = "data/BIOMD0000000661.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Webb2002FasFaslMediatedTumorTCellInteractBiomd0000000661Model = SbmlWebb2002FasFaslMediatedTumorTCellInteraction
