...
"""Auto-generated SBML BioModule wrapper for Leber2016 - Host immune response - H.pylori infection.

Source: biomodels_ebi:MODEL1611160002
Original: https://www.ebi.ac.uk/biomodels/MODEL1611160002
"""
...
class SbmlLeber2016HostImmuneResponseHPyloriInfection(biosim.BioModule):
    """BioModule wrapper for SBML model: Leber2016 - Host immune response - H.pylori infection."""

    def __init__(self, model_path: str = "data/MODEL1611160002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Leber2016HostImmuneResponseHPyloriInfectioModel1611160002Model = SbmlLeber2016HostImmuneResponseHPyloriInfection
