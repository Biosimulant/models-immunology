...
"""Auto-generated SBML BioModule wrapper for Wilkie2013r - immune-induced cancer dormancy and immune evasion-resistance.

Source: biomodels_ebi:BIOMD0000000752
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000752
"""
...
class SbmlWilkie2013rImmuneInducedCancerDormancyAndImmune(biosim.BioModule):
    """BioModule wrapper for SBML model: Wilkie2013r - immune-induced cancer dormancy and immune evasion-resistance."""

    def __init__(self, model_path: str = "data/BIOMD0000000752.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wilkie2013rImmuneInducedCancerDormancyAndIBiomd0000000752Model = SbmlWilkie2013rImmuneInducedCancerDormancyAndImmune
