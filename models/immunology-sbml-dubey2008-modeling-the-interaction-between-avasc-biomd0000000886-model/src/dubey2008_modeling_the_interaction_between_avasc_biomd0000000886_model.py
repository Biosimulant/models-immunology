...
"""Auto-generated SBML BioModule wrapper for Dubey2008 - Modeling the interaction between avascular cancerous cells and acquired immune response.

Source: biomodels_ebi:BIOMD0000000886
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000886
"""
...
class SbmlDubey2008ModelingTheInteractionBetweenAvascular(biosim.BioModule):
    """BioModule wrapper for SBML model: Dubey2008 - Modeling the interaction between avascular cancerous cells and acquired immune response."""

    def __init__(self, model_path: str = "data/BIOMD0000000886.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dubey2008ModelingTheInteractionBetweenAvascBiomd0000000886Model = SbmlDubey2008ModelingTheInteractionBetweenAvascular
