...
"""Auto-generated SBML BioModule wrapper for Gallaher2018 - Tumor–Immune dynamics in multiple myeloma.

Source: biomodels_ebi:BIOMD0000000743
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000743
"""
...
class SbmlGallaher2018TumorimmuneDynamicsInMultipleMyeloma(biosim.BioModule):
    """BioModule wrapper for SBML model: Gallaher2018 - Tumor–Immune dynamics in multiple myeloma."""

    def __init__(self, model_path: str = "data/BIOMD0000000743.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gallaher2018TumorImmuneDynamicsInMultipleMBiomd0000000743Model = SbmlGallaher2018TumorimmuneDynamicsInMultipleMyeloma
