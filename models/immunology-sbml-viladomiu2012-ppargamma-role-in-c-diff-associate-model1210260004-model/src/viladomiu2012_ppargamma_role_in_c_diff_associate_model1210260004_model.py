...
"""Auto-generated SBML BioModule wrapper for Viladomiu2012 - PPARgamma role in C.diff associated disease.

Source: biomodels_ebi:MODEL1210260004
Original: https://www.ebi.ac.uk/biomodels/MODEL1210260004
"""
...
class SbmlViladomiu2012PpargammaRoleInCDiffAssociatedDisease(biosim.BioModule):
    """BioModule wrapper for SBML model: Viladomiu2012 - PPARgamma role in C.diff associated disease."""

    def __init__(self, model_path: str = "data/MODEL1210260004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Viladomiu2012PpargammaRoleInCDiffAssociateModel1210260004Model = SbmlViladomiu2012PpargammaRoleInCDiffAssociatedDisease
