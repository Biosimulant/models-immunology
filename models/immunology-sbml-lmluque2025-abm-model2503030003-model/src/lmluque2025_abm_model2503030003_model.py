...
"""Auto-generated SBML BioModule wrapper for LMLuque2025 - ABM.

Source: biomodels_ebi:MODEL2503030003
Original: https://www.ebi.ac.uk/biomodels/MODEL2503030003
"""
...
class SbmlLmluque2025Abm(biosim.BioModule):
    """BioModule wrapper for SBML model: LMLuque2025 - ABM."""

    def __init__(self, model_path: str = "data/MODEL2503030003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lmluque2025AbmModel2503030003Model = SbmlLmluque2025Abm
