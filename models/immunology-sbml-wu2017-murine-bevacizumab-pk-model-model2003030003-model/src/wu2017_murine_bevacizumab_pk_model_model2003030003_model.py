...
"""Auto-generated SBML BioModule wrapper for Wu2017 - Murine Bevacizumab PK model.

Source: biomodels_ebi:MODEL2003030003
Original: https://www.ebi.ac.uk/biomodels/MODEL2003030003
"""
...
class SbmlWu2017MurineBevacizumabPkModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Wu2017 - Murine Bevacizumab PK model."""

    def __init__(self, model_path: str = "data/MODEL2003030003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wu2017MurineBevacizumabPkModelModel2003030003Model = SbmlWu2017MurineBevacizumabPkModel
