...
"""Auto-generated SBML BioModule wrapper for Kirschner1998_Immunotherapy_Tumour.

Source: biomodels_ebi:BIOMD0000000732
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000732
"""
...
class SbmlKirschner1998ImmunotherapyTumour(biosim.BioModule):
    """BioModule wrapper for SBML model: Kirschner1998_Immunotherapy_Tumour."""

    def __init__(self, model_path: str = "data/BIOMD0000000732.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kirschner1998ImmunotherapyTumourBiomd0000000732Model = SbmlKirschner1998ImmunotherapyTumour
