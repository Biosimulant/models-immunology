...
"""Auto-generated SBML BioModule wrapper for Rangel-Reyes2017 - Dendritic Immunotherapy Improvement for an Optimal Control Murine Model.

Source: biomodels_ebi:MODEL1909160002
Original: https://www.ebi.ac.uk/biomodels/MODEL1909160002
"""
...
class SbmlRangelReyes2017DendriticImmunotherapyImprovementForAn(biosim.BioModule):
    """BioModule wrapper for SBML model: Rangel-Reyes2017 - Dendritic Immunotherapy Improvement for an Optimal Control Murine Model."""

    def __init__(self, model_path: str = "data/MODEL1909160002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
RangelReyes2017DendriticImmunotherapyImproveModel1909160002Model = SbmlRangelReyes2017DendriticImmunotherapyImprovementForAn
