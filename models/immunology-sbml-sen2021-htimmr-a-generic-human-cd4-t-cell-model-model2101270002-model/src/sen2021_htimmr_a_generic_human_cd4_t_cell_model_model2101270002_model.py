...
"""Auto-generated SBML BioModule wrapper for Sen2021 - HTimmR - A generic human CD4+ T-cell model.

Source: biomodels_ebi:MODEL2101270002
Original: https://www.ebi.ac.uk/biomodels/MODEL2101270002
"""
...
class SbmlSen2021HtimmrAGenericHumanCd4TCellModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Sen2021 - HTimmR - A generic human CD4+ T-cell model."""

    def __init__(self, model_path: str = "data/MODEL2101270002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sen2021HtimmrAGenericHumanCd4TCellModelModel2101270002Model = SbmlSen2021HtimmrAGenericHumanCd4TCellModel
