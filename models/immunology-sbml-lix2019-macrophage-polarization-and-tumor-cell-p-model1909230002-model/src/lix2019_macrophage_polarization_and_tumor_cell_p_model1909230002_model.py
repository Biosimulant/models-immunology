...
"""Auto-generated SBML BioModule wrapper for LiX2019 - macrophage polarization and tumor cell plasticity.

Source: biomodels_ebi:MODEL1909230002
Original: https://www.ebi.ac.uk/biomodels/MODEL1909230002
"""
...
class SbmlLix2019MacrophagePolarizationAndTumorCellPlasticity(biosim.BioModule):
    """BioModule wrapper for SBML model: LiX2019 - macrophage polarization and tumor cell plasticity."""

    def __init__(self, model_path: str = "data/MODEL1909230002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lix2019MacrophagePolarizationAndTumorCellPModel1909230002Model = SbmlLix2019MacrophagePolarizationAndTumorCellPlasticity
