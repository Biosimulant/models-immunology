...
"""Auto-generated SBML BioModule wrapper for Garcia2018basic - cancer and immune cell count basic model.

Source: biomodels_ebi:BIOMD0000000742
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000742
"""
...
class SbmlGarcia2018basicCancerAndImmuneCellCountBasicModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Garcia2018basic - cancer and immune cell count basic model."""

    def __init__(self, model_path: str = "data/BIOMD0000000742.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Garcia2018basicCancerAndImmuneCellCountBasBiomd0000000742Model = SbmlGarcia2018basicCancerAndImmuneCellCountBasicModel
