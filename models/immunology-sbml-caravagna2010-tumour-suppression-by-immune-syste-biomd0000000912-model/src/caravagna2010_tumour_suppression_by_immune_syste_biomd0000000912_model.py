...
"""Auto-generated SBML BioModule wrapper for Caravagna2010 - Tumour suppression by immune system.

Source: biomodels_ebi:BIOMD0000000912
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000912
"""
...
class SbmlCaravagna2010TumourSuppressionByImmuneSystem(biosim.BioModule):
    """BioModule wrapper for SBML model: Caravagna2010 - Tumour suppression by immune system."""

    def __init__(self, model_path: str = "data/BIOMD0000000912.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Caravagna2010TumourSuppressionByImmuneSysteBiomd0000000912Model = SbmlCaravagna2010TumourSuppressionByImmuneSystem
