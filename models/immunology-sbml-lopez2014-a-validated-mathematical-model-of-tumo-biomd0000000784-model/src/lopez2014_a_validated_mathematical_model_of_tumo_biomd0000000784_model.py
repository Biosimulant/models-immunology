...
"""Auto-generated SBML BioModule wrapper for Lopez2014 - A Validated Mathematical Model of Tumor Growth Including Tumor-Host Interaction and Cell-Mediated Immune Response.

Source: biomodels_ebi:BIOMD0000000784
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000784
"""
...
class SbmlLopez2014AValidatedMathematicalModelOfTumorGrowth(biosim.BioModule):
    """BioModule wrapper for SBML model: Lopez2014 - A Validated Mathematical Model of Tumor Growth Including Tumor-Host Interaction and Cell-Mediated Immune Response."""

    def __init__(self, model_path: str = "data/BIOMD0000000784.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lopez2014AValidatedMathematicalModelOfTumoBiomd0000000784Model = SbmlLopez2014AValidatedMathematicalModelOfTumorGrowth
