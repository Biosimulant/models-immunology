...
"""Auto-generated SBML BioModule wrapper for Mullinax2016 - Mathematical model of tumor-immune cell interactions to optimize the meta-phenotype of TIL subpopulations.

Source: biomodels_ebi:MODEL2109110006
Original: https://www.ebi.ac.uk/biomodels/MODEL2109110006
"""
...
class SbmlMullinax2016MathematicalModelOfTumorImmuneCell(biosim.BioModule):
    """BioModule wrapper for SBML model: Mullinax2016 - Mathematical model of tumor-immune cell interactions to optimize the meta-phenotype of TIL subpopulations."""

    def __init__(self, model_path: str = "data/MODEL2109110006.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mullinax2016MathematicalModelOfTumorImmuneModel2109110006Model = SbmlMullinax2016MathematicalModelOfTumorImmuneCell
