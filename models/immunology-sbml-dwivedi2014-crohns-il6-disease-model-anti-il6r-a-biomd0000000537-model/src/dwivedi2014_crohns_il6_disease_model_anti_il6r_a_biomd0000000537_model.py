...
"""Auto-generated SBML BioModule wrapper for Dwivedi2014 - Crohns IL6 Disease model - Anti-IL6R Antibody.

Source: biomodels_ebi:BIOMD0000000537
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000537
"""
...
class SbmlDwivedi2014CrohnsIl6DiseaseModelAntiIl6rAntibody(biosim.BioModule):
    """BioModule wrapper for SBML model: Dwivedi2014 - Crohns IL6 Disease model - Anti-IL6R Antibody."""

    def __init__(self, model_path: str = "data/BIOMD0000000537.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dwivedi2014CrohnsIl6DiseaseModelAntiIl6rABiomd0000000537Model = SbmlDwivedi2014CrohnsIl6DiseaseModelAntiIl6rAntibody
