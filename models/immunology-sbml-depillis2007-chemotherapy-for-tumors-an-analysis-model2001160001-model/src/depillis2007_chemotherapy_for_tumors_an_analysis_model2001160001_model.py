...
"""Auto-generated SBML BioModule wrapper for dePillis2007 - Chemotherapy for tumors An analysis of the dynamics and a study of quadratic and linear optimal controls.

Source: biomodels_ebi:MODEL2001160001
Original: https://www.ebi.ac.uk/biomodels/MODEL2001160001
"""
...
class SbmlDepillis2007ChemotherapyForTumorsAnAnalysisOfThe(biosim.BioModule):
    """BioModule wrapper for SBML model: dePillis2007 - Chemotherapy for tumors An analysis of the dynamics and a study of quadratic and linear optimal controls."""

    def __init__(self, model_path: str = "data/MODEL2001160001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Depillis2007ChemotherapyForTumorsAnAnalysisModel2001160001Model = SbmlDepillis2007ChemotherapyForTumorsAnAnalysisOfThe
