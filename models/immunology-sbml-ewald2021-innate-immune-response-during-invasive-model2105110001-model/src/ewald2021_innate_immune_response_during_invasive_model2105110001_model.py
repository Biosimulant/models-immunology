...
"""Auto-generated SBML BioModule wrapper for Ewald2021 - Innate immune response during invasive aspergillosis by dynamic optimization.

Source: biomodels_ebi:MODEL2105110001
Original: https://www.ebi.ac.uk/biomodels/MODEL2105110001
"""
...
class SbmlEwald2021InnateImmuneResponseDuringInvasive(biosim.BioModule):
    """BioModule wrapper for SBML model: Ewald2021 - Innate immune response during invasive aspergillosis by dynamic optimization."""

    def __init__(self, model_path: str = "data/MODEL2105110001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ewald2021InnateImmuneResponseDuringInvasiveModel2105110001Model = SbmlEwald2021InnateImmuneResponseDuringInvasive
