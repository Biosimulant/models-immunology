...
"""Auto-generated SBML BioModule wrapper for Mol2013 - Immune Signal Transduction in Leishmaniasis.

Source: biomodels_ebi:BIOMD0000000477
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000477
"""
...
class SbmlMol2013ImmuneSignalTransductionInLeishmaniasis(biosim.BioModule):
    """BioModule wrapper for SBML model: Mol2013 - Immune Signal Transduction in Leishmaniasis."""

    def __init__(self, model_path: str = "data/BIOMD0000000477.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mol2013ImmuneSignalTransductionInLeishmaniaBiomd0000000477Model = SbmlMol2013ImmuneSignalTransductionInLeishmaniasis
