...
"""Auto-generated SBML BioModule wrapper for Phan2017 - innate immune in oncolytic virotherapy.

Source: biomodels_ebi:BIOMD0000000748
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000748
"""
...
class SbmlPhan2017InnateImmuneInOncolyticVirotherapy(biosim.BioModule):
    """BioModule wrapper for SBML model: Phan2017 - innate immune in oncolytic virotherapy."""

    def __init__(self, model_path: str = "data/BIOMD0000000748.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Phan2017InnateImmuneInOncolyticVirotherapyBiomd0000000748Model = SbmlPhan2017InnateImmuneInOncolyticVirotherapy
