...
"""Auto-generated SBML BioModule wrapper for Parra_Guillen2013 -  Mathematical model approach to describe tumour response in mice after vaccine administration_model1.

Source: biomodels_ebi:BIOMD0000000914
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000914
"""
...
class SbmlParraGuillen2013MathematicalModelApproachToDescribe(biosim.BioModule):
    """BioModule wrapper for SBML model: Parra_Guillen2013 -  Mathematical model approach to describe tumour response in mice after vaccine administration_model1."""

    def __init__(self, model_path: str = "data/BIOMD0000000914.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ParraGuillen2013MathematicalModelApproachToBiomd0000000914Model = SbmlParraGuillen2013MathematicalModelApproachToDescribe
