...
"""Auto-generated SBML BioModule wrapper for Dwivedi2014 - Crohns IL6 Disease model - sgp130 activity.

Source: biomodels_ebi:BIOMD0000000536
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000536
"""
...
class SbmlDwivedi2014CrohnsIl6DiseaseModelSgp130Activity(biosim.BioModule):
    """BioModule wrapper for SBML model: Dwivedi2014 - Crohns IL6 Disease model - sgp130 activity."""

    def __init__(self, model_path: str = "data/BIOMD0000000536.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dwivedi2014CrohnsIl6DiseaseModelSgp130ActiBiomd0000000536Model = SbmlDwivedi2014CrohnsIl6DiseaseModelSgp130Activity
