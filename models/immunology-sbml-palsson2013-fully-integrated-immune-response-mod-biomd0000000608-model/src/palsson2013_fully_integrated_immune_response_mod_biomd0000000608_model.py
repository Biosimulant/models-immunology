...
"""Auto-generated SBML BioModule wrapper for Palsson2013 - Fully-integrated immune response model (FIRM).

Source: biomodels_ebi:BIOMD0000000608
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000608
"""
...
class SbmlPalsson2013FullyIntegratedImmuneResponseModelFirm(biosim.BioModule):
    """BioModule wrapper for SBML model: Palsson2013 - Fully-integrated immune response model (FIRM)."""

    def __init__(self, model_path: str = "data/BIOMD0000000608.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Palsson2013FullyIntegratedImmuneResponseModBiomd0000000608Model = SbmlPalsson2013FullyIntegratedImmuneResponseModelFirm
