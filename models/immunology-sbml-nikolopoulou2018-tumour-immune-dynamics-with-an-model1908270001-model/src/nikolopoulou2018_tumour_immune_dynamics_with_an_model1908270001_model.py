...
"""Auto-generated SBML BioModule wrapper for Nikolopoulou2018 - Tumour-immune dynamics with an immune checkpoint inhibitor.

Source: biomodels_ebi:MODEL1908270001
Original: https://www.ebi.ac.uk/biomodels/MODEL1908270001
"""
...
class SbmlNikolopoulou2018TumourImmuneDynamicsWithAnImmune(biosim.BioModule):
    """BioModule wrapper for SBML model: Nikolopoulou2018 - Tumour-immune dynamics with an immune checkpoint inhibitor."""

    def __init__(self, model_path: str = "data/MODEL1908270001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nikolopoulou2018TumourImmuneDynamicsWithAnModel1908270001Model = SbmlNikolopoulou2018TumourImmuneDynamicsWithAnImmune
