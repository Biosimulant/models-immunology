...
"""Auto-generated SBML BioModule wrapper for Nwabugwu2013 - A Tumor-Immune Mathematical Model of CD4+ T Helper Cell.

Source: biomodels_ebi:MODEL2007090001
Original: https://www.ebi.ac.uk/biomodels/MODEL2007090001
"""
...
class SbmlNwabugwu2013ATumorImmuneMathematicalModelOfCd4T(biosim.BioModule):
    """BioModule wrapper for SBML model: Nwabugwu2013 - A Tumor-Immune Mathematical Model of CD4+ T Helper Cell."""

    def __init__(self, model_path: str = "data/MODEL2007090001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nwabugwu2013ATumorImmuneMathematicalModelOModel2007090001Model = SbmlNwabugwu2013ATumorImmuneMathematicalModelOfCd4T
