...
"""Auto-generated SBML BioModule wrapper for Malinzi2018 - tumour-immune interaction model.

Source: biomodels_ebi:BIOMD0000000809
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000809
"""
...
class SbmlMalinzi2018TumourImmuneInteractionModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Malinzi2018 - tumour-immune interaction model."""

    def __init__(self, model_path: str = "data/BIOMD0000000809.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Malinzi2018TumourImmuneInteractionModelBiomd0000000809Model = SbmlMalinzi2018TumourImmuneInteractionModel
