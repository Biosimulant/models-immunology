...
"""Auto-generated SBML BioModule wrapper for Abbott2021 - Prediction of Immunotherapy Response in Melanoma through Combined Modeling of NB and Immune-Related Resistance Mechanisms.

Source: biomodels_ebi:MODEL2407210001
Original: https://www.ebi.ac.uk/biomodels/MODEL2407210001
"""
...
class SbmlAbbott2021PredictionOfImmunotherapyResponseInMelanoma(biosim.BioModule):
    """BioModule wrapper for SBML model: Abbott2021 - Prediction of Immunotherapy Response in Melanoma through Combined Modeling of NB and Immune-Related Resistance Mechanisms."""

    def __init__(self, model_path: str = "data/MODEL2407210001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Abbott2021PredictionOfImmunotherapyResponseModel2407210001Model = SbmlAbbott2021PredictionOfImmunotherapyResponseInMelanoma
