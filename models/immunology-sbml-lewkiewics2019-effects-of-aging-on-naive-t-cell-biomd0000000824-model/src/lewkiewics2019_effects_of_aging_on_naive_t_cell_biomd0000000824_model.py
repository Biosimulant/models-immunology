...
"""Auto-generated SBML BioModule wrapper for Lewkiewics2019 - effects of aging on naive T cell populations and diversity.

Source: biomodels_ebi:BIOMD0000000824
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000824
"""
...
class SbmlLewkiewics2019EffectsOfAgingOnNaiveTCellPopulations(biosim.BioModule):
    """BioModule wrapper for SBML model: Lewkiewics2019 - effects of aging on naive T cell populations and diversity."""

    def __init__(self, model_path: str = "data/BIOMD0000000824.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lewkiewics2019EffectsOfAgingOnNaiveTCellBiomd0000000824Model = SbmlLewkiewics2019EffectsOfAgingOnNaiveTCellPopulations
