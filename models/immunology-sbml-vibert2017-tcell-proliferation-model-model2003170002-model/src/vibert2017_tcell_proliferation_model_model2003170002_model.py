...
"""Auto-generated SBML BioModule wrapper for Vibert2017 - Tcell proliferation model.

Source: biomodels_ebi:MODEL2003170002
Original: https://www.ebi.ac.uk/biomodels/MODEL2003170002
"""
...
class SbmlVibert2017TcellProliferationModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Vibert2017 - Tcell proliferation model."""

    def __init__(self, model_path: str = "data/MODEL2003170002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Vibert2017TcellProliferationModelModel2003170002Model = SbmlVibert2017TcellProliferationModel
