...
"""Auto-generated SBML BioModule wrapper for Hernandez-Vargas2012 - Innate immune system dynamics to Influenza virus.

Source: biomodels_ebi:BIOMD0000000710
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000710
"""
...
class SbmlHernandezVargas2012InnateImmuneSystemDynamicsTo(biosim.BioModule):
    """BioModule wrapper for SBML model: Hernandez-Vargas2012 - Innate immune system dynamics to Influenza virus."""

    def __init__(self, model_path: str = "data/BIOMD0000000710.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
HernandezVargas2012InnateImmuneSystemDynamiBiomd0000000710Model = SbmlHernandezVargas2012InnateImmuneSystemDynamicsTo
