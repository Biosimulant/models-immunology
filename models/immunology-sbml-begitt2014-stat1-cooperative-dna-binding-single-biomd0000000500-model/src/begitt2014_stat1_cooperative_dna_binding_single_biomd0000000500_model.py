...
"""Auto-generated SBML BioModule wrapper for Begitt2014 - STAT1 cooperative DNA binding - single GAS polymer model.

Source: biomodels_ebi:BIOMD0000000500
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000500
"""
...
class SbmlBegitt2014Stat1CooperativeDnaBindingSingleGasPolymer(biosim.BioModule):
    """BioModule wrapper for SBML model: Begitt2014 - STAT1 cooperative DNA binding - single GAS polymer model."""

    def __init__(self, model_path: str = "data/BIOMD0000000500.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Begitt2014Stat1CooperativeDnaBindingSingleBiomd0000000500Model = SbmlBegitt2014Stat1CooperativeDnaBindingSingleGasPolymer
