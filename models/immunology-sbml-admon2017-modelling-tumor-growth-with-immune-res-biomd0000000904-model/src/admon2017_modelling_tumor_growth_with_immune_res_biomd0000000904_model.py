...
"""Auto-generated SBML BioModule wrapper for Admon2017 - Modelling tumor growth with immune response and drug using ordinary differential equations.

Source: biomodels_ebi:BIOMD0000000904
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000904
"""
...
class SbmlAdmon2017ModellingTumorGrowthWithImmuneResponseAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Admon2017 - Modelling tumor growth with immune response and drug using ordinary differential equations."""

    def __init__(self, model_path: str = "data/BIOMD0000000904.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Admon2017ModellingTumorGrowthWithImmuneResBiomd0000000904Model = SbmlAdmon2017ModellingTumorGrowthWithImmuneResponseAnd
