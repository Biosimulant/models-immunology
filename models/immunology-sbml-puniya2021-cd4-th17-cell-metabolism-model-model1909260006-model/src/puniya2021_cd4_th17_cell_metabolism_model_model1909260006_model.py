...
"""Auto-generated SBML BioModule wrapper for Puniya2021 - CD4+ Th17 cell metabolism model.

Source: biomodels_ebi:MODEL1909260006
Original: https://www.ebi.ac.uk/biomodels/MODEL1909260006
"""
...
class SbmlPuniya2021Cd4Th17CellMetabolismModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Puniya2021 - CD4+ Th17 cell metabolism model."""

    def __init__(self, model_path: str = "data/MODEL1909260006.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Puniya2021Cd4Th17CellMetabolismModelModel1909260006Model = SbmlPuniya2021Cd4Th17CellMetabolismModel
