...
"""Auto-generated SBML BioModule wrapper for Al-Tuwairqi2020 - Dynamics of cancer virotherapy with immune response.

Source: biomodels_ebi:BIOMD0000001035
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001035
"""
...
class SbmlAlTuwairqi2020DynamicsOfCancerVirotherapyWithImmune(biosim.BioModule):
    """BioModule wrapper for SBML model: Al-Tuwairqi2020 - Dynamics of cancer virotherapy with immune response."""

    def __init__(self, model_path: str = "data/BIOMD0000001035.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AlTuwairqi2020DynamicsOfCancerVirotherapyWBiomd0000001035Model = SbmlAlTuwairqi2020DynamicsOfCancerVirotherapyWithImmune
