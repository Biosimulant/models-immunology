...
"""Auto-generated SBML BioModule wrapper for Sumana2018 - Mathematical modeling of cancer-immune system, considering the role of antibodies..

Source: biomodels_ebi:BIOMD0000000885
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000885
"""
...
class SbmlSumana2018MathematicalModelingOfCancerImmuneSystem(biosim.BioModule):
    """BioModule wrapper for SBML model: Sumana2018 - Mathematical modeling of cancer-immune system, considering the role of antibodies.."""

    def __init__(self, model_path: str = "data/BIOMD0000000885.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sumana2018MathematicalModelingOfCancerImmunBiomd0000000885Model = SbmlSumana2018MathematicalModelingOfCancerImmuneSystem
