...
"""Auto-generated SBML BioModule wrapper for Montagud2022 - Prostate cancer Boolean model.

Source: biomodels_ebi:MODEL2106070001
Original: https://www.ebi.ac.uk/biomodels/MODEL2106070001
"""
...
class SbmlMontagud2022ProstateCancerBooleanModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Montagud2022 - Prostate cancer Boolean model."""

    def __init__(self, model_path: str = "data/MODEL2106070001.sbml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Montagud2022ProstateCancerBooleanModelModel2106070001Model = SbmlMontagud2022ProstateCancerBooleanModel
