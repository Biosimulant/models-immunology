...
"""Auto-generated SBML BioModule wrapper for Maree2006_DuCa_Type1DiabetesModel.

Source: biomodels_ebi:BIOMD0000000381
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000381
"""
...
class SbmlMaree2006DucaType1diabetesmodel(biosim.BioModule):
    """BioModule wrapper for SBML model: Maree2006_DuCa_Type1DiabetesModel."""

    def __init__(self, model_path: str = "data/BIOMD0000000381.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Maree2006DucaType1diabetesmodelBiomd0000000381Model = SbmlMaree2006DucaType1diabetesmodel
