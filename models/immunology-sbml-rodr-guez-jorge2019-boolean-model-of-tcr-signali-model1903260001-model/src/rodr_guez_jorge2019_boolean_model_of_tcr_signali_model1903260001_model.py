...
"""Auto-generated SBML BioModule wrapper for Rodríguez-Jorge2019 - Boolean model of TCR signaling for CD4 + T cell activation.

Source: biomodels_ebi:MODEL1903260001
Original: https://www.ebi.ac.uk/biomodels/MODEL1903260001
"""
...
class SbmlRodriguezJorge2019BooleanModelOfTcrSignalingForCd4(biosim.BioModule):
    """BioModule wrapper for SBML model: Rodríguez-Jorge2019 - Boolean model of TCR signaling for CD4 + T cell activation."""

    def __init__(self, model_path: str = "data/MODEL1903260001.sbml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
RodrGuezJorge2019BooleanModelOfTcrSignaliModel1903260001Model = SbmlRodriguezJorge2019BooleanModelOfTcrSignalingForCd4
