...
"""Auto-generated SBML BioModule wrapper for Louzoun2014 - A mathematical model for pancreatic cancer growth and treatments.

Source: biomodels_ebi:MODEL1909100002
Original: https://www.ebi.ac.uk/biomodels/MODEL1909100002
"""
...
class SbmlLouzoun2014AMathematicalModelForPancreaticCancer(biosim.BioModule):
    """BioModule wrapper for SBML model: Louzoun2014 - A mathematical model for pancreatic cancer growth and treatments."""

    def __init__(self, model_path: str = "data/MODEL1909100002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Louzoun2014AMathematicalModelForPancreaticModel1909100002Model = SbmlLouzoun2014AMathematicalModelForPancreaticCancer
