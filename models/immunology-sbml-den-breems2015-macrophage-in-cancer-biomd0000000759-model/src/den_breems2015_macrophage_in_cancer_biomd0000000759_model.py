...
"""Auto-generated SBML BioModule wrapper for den Breems2015 - macrophage in cancer.

Source: biomodels_ebi:BIOMD0000000759
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000759
"""
...
class SbmlDenBreems2015MacrophageInCancer(biosim.BioModule):
    """BioModule wrapper for SBML model: den Breems2015 - macrophage in cancer."""

    def __init__(self, model_path: str = "data/BIOMD0000000759.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
DenBreems2015MacrophageInCancerBiomd0000000759Model = SbmlDenBreems2015MacrophageInCancer
