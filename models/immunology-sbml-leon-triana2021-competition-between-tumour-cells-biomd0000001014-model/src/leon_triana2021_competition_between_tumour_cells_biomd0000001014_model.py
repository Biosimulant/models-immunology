...
"""Auto-generated SBML BioModule wrapper for Leon-Triana2021 - Competition between tumour cells and dual-target CAR T-cells.

Source: biomodels_ebi:BIOMD0000001014
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001014
"""
...
class SbmlLeonTriana2021CompetitionBetweenTumourCellsAndDual(biosim.BioModule):
    """BioModule wrapper for SBML model: Leon-Triana2021 - Competition between tumour cells and dual-target CAR T-cells."""

    def __init__(self, model_path: str = "data/BIOMD0000001014.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
LeonTriana2021CompetitionBetweenTumourCellsBiomd0000001014Model = SbmlLeonTriana2021CompetitionBetweenTumourCellsAndDual
