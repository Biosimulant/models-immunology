...
"""Auto-generated SBML BioModule wrapper for Martinez-Sanchez2015 - T CD4+ lymphocyte transcriptional-signaling regulatory network.

Source: biomodels_ebi:BIOMD0000000593
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000593
"""
...
class SbmlMartinezSanchez2015TCd4LymphocyteTranscriptional2(biosim.BioModule):
    """BioModule wrapper for SBML model: Martinez-Sanchez2015 - T CD4+ lymphocyte transcriptional-signaling regulatory network."""

    def __init__(self, model_path: str = "data/BIOMD0000000593.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MartinezSanchez2015TCd4LymphocyteTranscriptBiomd0000000593Model = SbmlMartinezSanchez2015TCd4LymphocyteTranscriptional2
