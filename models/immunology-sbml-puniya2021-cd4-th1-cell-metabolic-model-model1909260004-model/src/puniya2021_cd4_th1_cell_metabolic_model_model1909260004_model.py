...
"""Auto-generated SBML BioModule wrapper for Puniya2021 - CD4+ Th1 cell metabolic model.

Source: biomodels_ebi:MODEL1909260004
Original: https://www.ebi.ac.uk/biomodels/MODEL1909260004
"""
...
class SbmlPuniya2021Cd4Th1CellMetabolicModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Puniya2021 - CD4+ Th1 cell metabolic model."""

    def __init__(self, model_path: str = "data/MODEL1909260004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Puniya2021Cd4Th1CellMetabolicModelModel1909260004Model = SbmlPuniya2021Cd4Th1CellMetabolicModel
