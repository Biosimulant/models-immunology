...
"""Auto-generated SBML BioModule wrapper for Bidot2008 - Mathematical modelling of T cell activation kinetics.

Source: biomodels_ebi:MODEL1910290003
Original: https://www.ebi.ac.uk/biomodels/MODEL1910290003
"""
...
class SbmlBidot2008MathematicalModellingOfTCellActivation(biosim.BioModule):
    """BioModule wrapper for SBML model: Bidot2008 - Mathematical modelling of T cell activation kinetics."""

    def __init__(self, model_path: str = "data/MODEL1910290003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bidot2008MathematicalModellingOfTCellActivModel1910290003Model = SbmlBidot2008MathematicalModellingOfTCellActivation
