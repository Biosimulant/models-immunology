...
"""Auto-generated SBML BioModule wrapper for Verma2016 - HIV and HPV co-infection, T-cell response.

Source: biomodels_ebi:BIOMD0000000872
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000872
"""
...
class SbmlVerma2016HivAndHpvCoInfectionTCellResponse(biosim.BioModule):
    """BioModule wrapper for SBML model: Verma2016 - HIV and HPV co-infection, T-cell response."""

    def __init__(self, model_path: str = "data/BIOMD0000000872.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Verma2016HivAndHpvCoInfectionTCellResponBiomd0000000872Model = SbmlVerma2016HivAndHpvCoInfectionTCellResponse
