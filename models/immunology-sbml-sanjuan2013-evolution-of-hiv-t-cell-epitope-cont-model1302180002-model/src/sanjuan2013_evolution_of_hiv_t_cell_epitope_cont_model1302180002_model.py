...
"""Auto-generated SBML BioModule wrapper for Sanjuan2013 - Evolution of HIV T-cell epitope, control model.

Source: biomodels_ebi:MODEL1302180002
Original: https://www.ebi.ac.uk/biomodels/MODEL1302180002
"""
...
class SbmlSanjuan2013EvolutionOfHivTCellEpitopeControlModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Sanjuan2013 - Evolution of HIV T-cell epitope, control model."""

    def __init__(self, model_path: str = "data/MODEL1302180002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sanjuan2013EvolutionOfHivTCellEpitopeContModel1302180002Model = SbmlSanjuan2013EvolutionOfHivTCellEpitopeControlModel
