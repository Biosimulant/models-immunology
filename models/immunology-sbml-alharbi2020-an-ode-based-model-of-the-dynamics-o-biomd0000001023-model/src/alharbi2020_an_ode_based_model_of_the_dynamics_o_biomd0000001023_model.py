...
"""Auto-generated SBML BioModule wrapper for Alharbi2020 - An ODE-based model of the dynamics of tumor cell progression and its effects on normal cell growth and immune system functionality.

Source: biomodels_ebi:BIOMD0000001023
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001023
"""
...
class SbmlAlharbi2020AnOdeBasedModelOfTheDynamicsOfTumor(biosim.BioModule):
    """BioModule wrapper for SBML model: Alharbi2020 - An ODE-based model of the dynamics of tumor cell progression and its effects on normal cell growth and immune system functionality."""

    def __init__(self, model_path: str = "data/BIOMD0000001023.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Alharbi2020AnOdeBasedModelOfTheDynamicsOBiomd0000001023Model = SbmlAlharbi2020AnOdeBasedModelOfTheDynamicsOfTumor
