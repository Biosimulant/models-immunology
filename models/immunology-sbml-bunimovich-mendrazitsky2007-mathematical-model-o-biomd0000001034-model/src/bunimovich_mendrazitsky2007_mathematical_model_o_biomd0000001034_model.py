...
"""Auto-generated SBML BioModule wrapper for Bunimovich-Mendrazitsky2007 - Mathematical model of BCG immunotherapy.

Source: biomodels_ebi:BIOMD0000001034
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001034
"""
...
class SbmlBunimovichMendrazitsky2007MathematicalModelOfBcg(biosim.BioModule):
    """BioModule wrapper for SBML model: Bunimovich-Mendrazitsky2007 - Mathematical model of BCG immunotherapy."""

    def __init__(self, model_path: str = "data/BIOMD0000001034.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BunimovichMendrazitsky2007MathematicalModelOBiomd0000001034Model = SbmlBunimovichMendrazitsky2007MathematicalModelOfBcg
