...
"""Auto-generated SBML BioModule wrapper for Wilkie2013b - immune-induced cancer dormancy and immune evasion-basic.

Source: biomodels_ebi:BIOMD0000000751
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000751
"""
...
class SbmlWilkie2013bImmuneInducedCancerDormancyAndImmune(biosim.BioModule):
    """BioModule wrapper for SBML model: Wilkie2013b - immune-induced cancer dormancy and immune evasion-basic."""

    def __init__(self, model_path: str = "data/BIOMD0000000751.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wilkie2013bImmuneInducedCancerDormancyAndIBiomd0000000751Model = SbmlWilkie2013bImmuneInducedCancerDormancyAndImmune
