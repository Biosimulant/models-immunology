...
"""Auto-generated SBML BioModule wrapper for Lavigne2021 - Non-spatial model of viral infection dynamics and interferon response of well-mixed viral infection.

Source: biomodels_ebi:BIOMD0000001021
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001021
"""
...
class SbmlLavigne2021NonSpatialModelOfViralInfectionDynamics(biosim.BioModule):
    """BioModule wrapper for SBML model: Lavigne2021 - Non-spatial model of viral infection dynamics and interferon response of well-mixed viral infection."""

    def __init__(self, model_path: str = "data/BIOMD0000001021.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lavigne2021NonSpatialModelOfViralInfectionBiomd0000001021Model = SbmlLavigne2021NonSpatialModelOfViralInfectionDynamics
