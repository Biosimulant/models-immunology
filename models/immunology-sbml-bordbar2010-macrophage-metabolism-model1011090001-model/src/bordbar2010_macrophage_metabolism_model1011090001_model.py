...
"""Auto-generated SBML BioModule wrapper for Bordbar2010_Macrophage_Metabolism.

Source: biomodels_ebi:MODEL1011090001
Original: https://www.ebi.ac.uk/biomodels/MODEL1011090001
"""
...
class SbmlBordbar2010MacrophageMetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Bordbar2010_Macrophage_Metabolism."""

    def __init__(self, model_path: str = "data/MODEL1011090001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bordbar2010MacrophageMetabolismModel1011090001Model = SbmlBordbar2010MacrophageMetabolism
