...
"""Auto-generated SBML BioModule wrapper for Banerjee2008 -  Immunotherapy with interleukin-2: A study based on mathematical modeling.

Source: biomodels_ebi:MODEL2001130001
Original: https://www.ebi.ac.uk/biomodels/MODEL2001130001
"""
...
class SbmlBanerjee2008ImmunotherapyWithInterleukin2AStudyBased(biosim.BioModule):
    """BioModule wrapper for SBML model: Banerjee2008 -  Immunotherapy with interleukin-2: A study based on mathematical modeling."""

    def __init__(self, model_path: str = "data/MODEL2001130001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Banerjee2008ImmunotherapyWithInterleukin2AModel2001130001Model = SbmlBanerjee2008ImmunotherapyWithInterleukin2AStudyBased
