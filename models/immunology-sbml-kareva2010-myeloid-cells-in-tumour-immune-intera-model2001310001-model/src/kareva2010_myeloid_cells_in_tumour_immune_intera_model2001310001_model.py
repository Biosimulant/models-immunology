...
"""Auto-generated SBML BioModule wrapper for Kareva2010 - Myeloid cells in tumour-immune interactions..

Source: biomodels_ebi:MODEL2001310001
Original: https://www.ebi.ac.uk/biomodels/MODEL2001310001
"""
...
class SbmlKareva2010MyeloidCellsInTumourImmuneInteractions(biosim.BioModule):
    """BioModule wrapper for SBML model: Kareva2010 - Myeloid cells in tumour-immune interactions.."""

    def __init__(self, model_path: str = "data/MODEL2001310001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kareva2010MyeloidCellsInTumourImmuneInteraModel2001310001Model = SbmlKareva2010MyeloidCellsInTumourImmuneInteractions
