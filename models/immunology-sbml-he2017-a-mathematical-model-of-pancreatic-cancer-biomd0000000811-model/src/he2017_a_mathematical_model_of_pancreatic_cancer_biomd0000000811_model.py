...
"""Auto-generated SBML BioModule wrapper for He2017 - A mathematical model of pancreatic cancer with two kinds of treatments.

Source: biomodels_ebi:BIOMD0000000811
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000811
"""
...
class SbmlHe2017AMathematicalModelOfPancreaticCancerWithTwo(biosim.BioModule):
    """BioModule wrapper for SBML model: He2017 - A mathematical model of pancreatic cancer with two kinds of treatments."""

    def __init__(self, model_path: str = "data/BIOMD0000000811.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
He2017AMathematicalModelOfPancreaticCancerBiomd0000000811Model = SbmlHe2017AMathematicalModelOfPancreaticCancerWithTwo
