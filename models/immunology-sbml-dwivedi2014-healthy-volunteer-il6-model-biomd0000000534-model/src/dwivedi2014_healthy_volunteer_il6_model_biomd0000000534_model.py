...
"""Auto-generated SBML BioModule wrapper for Dwivedi2014 - Healthy Volunteer IL6 Model.

Source: biomodels_ebi:BIOMD0000000534
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000534
"""
...
class SbmlDwivedi2014HealthyVolunteerIl6Model(biosim.BioModule):
    """BioModule wrapper for SBML model: Dwivedi2014 - Healthy Volunteer IL6 Model."""

    def __init__(self, model_path: str = "data/BIOMD0000000534.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dwivedi2014HealthyVolunteerIl6ModelBiomd0000000534Model = SbmlDwivedi2014HealthyVolunteerIl6Model
