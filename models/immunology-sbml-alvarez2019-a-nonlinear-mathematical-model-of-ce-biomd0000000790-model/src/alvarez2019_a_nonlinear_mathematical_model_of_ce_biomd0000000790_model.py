...
"""Auto-generated SBML BioModule wrapper for Alvarez2019 - A nonlinear mathematical model of cell-mediated immune response for tumor phenotypic heterogeneity.

Source: biomodels_ebi:BIOMD0000000790
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000790
"""
...
class SbmlAlvarez2019ANonlinearMathematicalModelOfCellMediated(biosim.BioModule):
    """BioModule wrapper for SBML model: Alvarez2019 - A nonlinear mathematical model of cell-mediated immune response for tumor phenotypic heterogeneity."""

    def __init__(self, model_path: str = "data/BIOMD0000000790.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Alvarez2019ANonlinearMathematicalModelOfCeBiomd0000000790Model = SbmlAlvarez2019ANonlinearMathematicalModelOfCellMediated
