...
"""Auto-generated SBML BioModule wrapper for Miao2014 - Dynamics and migratory pathways of virus-specific antibody-secreting cell populations.

Source: biomodels_ebi:MODEL1411130000
Original: https://www.ebi.ac.uk/biomodels/MODEL1411130000
"""
...
class SbmlMiao2014DynamicsAndMigratoryPathwaysOfVirusSpecific(biosim.BioModule):
    """BioModule wrapper for SBML model: Miao2014 - Dynamics and migratory pathways of virus-specific antibody-secreting cell populations."""

    def __init__(self, model_path: str = "data/MODEL1411130000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Miao2014DynamicsAndMigratoryPathwaysOfViruModel1411130000Model = SbmlMiao2014DynamicsAndMigratoryPathwaysOfVirusSpecific
