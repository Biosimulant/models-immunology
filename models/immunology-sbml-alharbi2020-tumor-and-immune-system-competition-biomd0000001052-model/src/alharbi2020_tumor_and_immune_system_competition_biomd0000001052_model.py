...
"""Auto-generated SBML BioModule wrapper for Alharbi2020 - Tumor and immune system competition.

Source: biomodels_ebi:BIOMD0000001052
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001052
"""
...
class SbmlAlharbi2020TumorAndImmuneSystemCompetition(biosim.BioModule):
    """BioModule wrapper for SBML model: Alharbi2020 - Tumor and immune system competition."""

    def __init__(self, model_path: str = "data/BIOMD0000001052.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Alharbi2020TumorAndImmuneSystemCompetitionBiomd0000001052Model = SbmlAlharbi2020TumorAndImmuneSystemCompetition
