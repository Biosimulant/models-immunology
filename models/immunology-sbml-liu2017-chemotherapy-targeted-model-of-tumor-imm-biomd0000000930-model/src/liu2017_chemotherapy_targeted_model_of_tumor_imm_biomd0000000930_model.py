...
"""Auto-generated SBML BioModule wrapper for Liu2017 - chemotherapy targeted model of tumor immune system.

Source: biomodels_ebi:BIOMD0000000930
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000930
"""
...
class SbmlLiu2017ChemotherapyTargetedModelOfTumorImmuneSystem(biosim.BioModule):
    """BioModule wrapper for SBML model: Liu2017 - chemotherapy targeted model of tumor immune system."""

    def __init__(self, model_path: str = "data/BIOMD0000000930.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Liu2017ChemotherapyTargetedModelOfTumorImmBiomd0000000930Model = SbmlLiu2017ChemotherapyTargetedModelOfTumorImmuneSystem
