...
"""Auto-generated SBML BioModule wrapper for Martinez-Sanchez2015 - T CD4+ lymphocyte transcriptional regulatory network.

Source: biomodels_ebi:BIOMD0000000592
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000592
"""
...
class SbmlMartinezSanchez2015TCd4LymphocyteTranscriptional(biosim.BioModule):
    """BioModule wrapper for SBML model: Martinez-Sanchez2015 - T CD4+ lymphocyte transcriptional regulatory network."""

    def __init__(self, model_path: str = "data/BIOMD0000000592.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MartinezSanchez2015TCd4LymphocyteTranscriptBiomd0000000592Model = SbmlMartinezSanchez2015TCd4LymphocyteTranscriptional
