...
"""Auto-generated SBML BioModule wrapper for Jarrett2018 - trastuzumab-induced immune response in murine HER2+ breast cancer model.

Source: biomodels_ebi:BIOMD0000000745
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000745
"""
...
class SbmlJarrett2018TrastuzumabInducedImmuneResponseInMurine(biosim.BioModule):
    """BioModule wrapper for SBML model: Jarrett2018 - trastuzumab-induced immune response in murine HER2+ breast cancer model."""

    def __init__(self, model_path: str = "data/BIOMD0000000745.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Jarrett2018TrastuzumabInducedImmuneResponseBiomd0000000745Model = SbmlJarrett2018TrastuzumabInducedImmuneResponseInMurine
