...
"""Auto-generated SBML BioModule wrapper for Eftimie2018 - Cancer and Immune biomarkers.

Source: biomodels_ebi:BIOMD0000000741
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000741
"""
...
class SbmlEftimie2018CancerAndImmuneBiomarkers(biosim.BioModule):
    """BioModule wrapper for SBML model: Eftimie2018 - Cancer and Immune biomarkers."""

    def __init__(self, model_path: str = "data/BIOMD0000000741.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Eftimie2018CancerAndImmuneBiomarkersBiomd0000000741Model = SbmlEftimie2018CancerAndImmuneBiomarkers
