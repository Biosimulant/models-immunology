...
"""Auto-generated SBML BioModule wrapper for Sigal2019 - Mathematical modelling of cancer stem cell-targeted immunotherapy.

Source: biomodels_ebi:MODEL1911270001
Original: https://www.ebi.ac.uk/biomodels/MODEL1911270001
"""
...
class SbmlSigal2019MathematicalModellingOfCancerStemCell(biosim.BioModule):
    """BioModule wrapper for SBML model: Sigal2019 - Mathematical modelling of cancer stem cell-targeted immunotherapy."""

    def __init__(self, model_path: str = "data/MODEL1911270001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sigal2019MathematicalModellingOfCancerStemModel1911270001Model = SbmlSigal2019MathematicalModellingOfCancerStemCell
