...
"""Auto-generated SBML BioModule wrapper for Wilson2012 - tumor vaccine efficacy.

Source: biomodels_ebi:BIOMD0000000791
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000791
"""
...
class SbmlWilson2012TumorVaccineEfficacy(biosim.BioModule):
    """BioModule wrapper for SBML model: Wilson2012 - tumor vaccine efficacy."""

    def __init__(self, model_path: str = "data/BIOMD0000000791.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wilson2012TumorVaccineEfficacyBiomd0000000791Model = SbmlWilson2012TumorVaccineEfficacy
