...
"""Auto-generated SBML BioModule wrapper for Hu2018 - Dynamics of tumor-CD4+-cytokine-host cells interactions with treatments.

Source: biomodels_ebi:BIOMD0000000797
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000797
"""
...
class SbmlHu2018DynamicsOfTumorCd4CytokineHostCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Hu2018 - Dynamics of tumor-CD4+-cytokine-host cells interactions with treatments."""

    def __init__(self, model_path: str = "data/BIOMD0000000797.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hu2018DynamicsOfTumorCd4CytokineHostCellsBiomd0000000797Model = SbmlHu2018DynamicsOfTumorCd4CytokineHostCells
