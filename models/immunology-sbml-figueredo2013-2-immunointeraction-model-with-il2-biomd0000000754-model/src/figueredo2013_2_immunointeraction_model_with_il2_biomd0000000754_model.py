...
"""Auto-generated SBML BioModule wrapper for Figueredo2013/2 - immunointeraction model with IL2.

Source: biomodels_ebi:BIOMD0000000754
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000754
"""
...
class SbmlFigueredo20132ImmunointeractionModelWithIl2(biosim.BioModule):
    """BioModule wrapper for SBML model: Figueredo2013/2 - immunointeraction model with IL2."""

    def __init__(self, model_path: str = "data/BIOMD0000000754.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Figueredo20132ImmunointeractionModelWithIl2Biomd0000000754Model = SbmlFigueredo20132ImmunointeractionModelWithIl2
