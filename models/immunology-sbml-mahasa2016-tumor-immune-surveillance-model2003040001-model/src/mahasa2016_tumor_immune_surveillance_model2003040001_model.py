...
"""Auto-generated SBML BioModule wrapper for Mahasa2016-tumor–immune surveillance.

Source: biomodels_ebi:MODEL2003040001
Original: https://www.ebi.ac.uk/biomodels/MODEL2003040001
"""
...
class SbmlMahasa2016TumorimmuneSurveillance(biosim.BioModule):
    """BioModule wrapper for SBML model: Mahasa2016-tumor–immune surveillance."""

    def __init__(self, model_path: str = "data/MODEL2003040001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mahasa2016TumorImmuneSurveillanceModel2003040001Model = SbmlMahasa2016TumorimmuneSurveillance
