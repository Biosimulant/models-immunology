...
"""Auto-generated SBML BioModule wrapper for Hanson2016 - Toxicity Management in CAR T cell therapy for B-ALL.

Source: biomodels_ebi:BIOMD0000000837
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000837
"""
...
class SbmlHanson2016ToxicityManagementInCarTCellTherapyForB(biosim.BioModule):
    """BioModule wrapper for SBML model: Hanson2016 - Toxicity Management in CAR T cell therapy for B-ALL."""

    def __init__(self, model_path: str = "data/BIOMD0000000837.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hanson2016ToxicityManagementInCarTCellTheBiomd0000000837Model = SbmlHanson2016ToxicityManagementInCarTCellTherapyForB
