...
"""Auto-generated SBML BioModule wrapper for Cappuccio2007 - Tumor-immune system interactions and determination of the optimal therapeutic protocol in immunotherapy.

Source: biomodels_ebi:BIOMD0000001036
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001036
"""
...
class SbmlCappuccio2007TumorImmuneSystemInteractionsAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Cappuccio2007 - Tumor-immune system interactions and determination of the optimal therapeutic protocol in immunotherapy."""

    def __init__(self, model_path: str = "data/BIOMD0000001036.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cappuccio2007TumorImmuneSystemInteractionsABiomd0000001036Model = SbmlCappuccio2007TumorImmuneSystemInteractionsAnd
