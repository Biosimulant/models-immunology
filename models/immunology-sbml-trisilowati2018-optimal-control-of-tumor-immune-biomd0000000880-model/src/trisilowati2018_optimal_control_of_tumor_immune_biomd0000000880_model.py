...
"""Auto-generated SBML BioModule wrapper for Trisilowati2018 - Optimal control of tumor-immune system interaction with treatment.

Source: biomodels_ebi:BIOMD0000000880
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000880
"""
...
class SbmlTrisilowati2018OptimalControlOfTumorImmuneSystem(biosim.BioModule):
    """BioModule wrapper for SBML model: Trisilowati2018 - Optimal control of tumor-immune system interaction with treatment."""

    def __init__(self, model_path: str = "data/BIOMD0000000880.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Trisilowati2018OptimalControlOfTumorImmuneBiomd0000000880Model = SbmlTrisilowati2018OptimalControlOfTumorImmuneSystem
