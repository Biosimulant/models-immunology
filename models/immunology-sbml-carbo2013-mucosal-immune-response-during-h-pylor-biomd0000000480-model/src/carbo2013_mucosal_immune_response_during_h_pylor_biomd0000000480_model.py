...
"""Auto-generated SBML BioModule wrapper for Carbo2013 - Mucosal Immune Response during H.pylori Infection.

Source: biomodels_ebi:BIOMD0000000480
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000480
"""
...
class SbmlCarbo2013MucosalImmuneResponseDuringHPyloriInfection(biosim.BioModule):
    """BioModule wrapper for SBML model: Carbo2013 - Mucosal Immune Response during H.pylori Infection."""

    def __init__(self, model_path: str = "data/BIOMD0000000480.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Carbo2013MucosalImmuneResponseDuringHPylorBiomd0000000480Model = SbmlCarbo2013MucosalImmuneResponseDuringHPyloriInfection
