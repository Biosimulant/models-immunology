...
"""Auto-generated SBML BioModule wrapper for Waugh2006 - Diabetic Wound Healing - TGF-B Dynamics.

Source: biomodels_ebi:BIOMD0000000680
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000680
"""
...
class SbmlWaugh2006DiabeticWoundHealingTgfBDynamics(biosim.BioModule):
    """BioModule wrapper for SBML model: Waugh2006 - Diabetic Wound Healing - TGF-B Dynamics."""

    def __init__(self, model_path: str = "data/BIOMD0000000680.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Waugh2006DiabeticWoundHealingTgfBDynamicsBiomd0000000680Model = SbmlWaugh2006DiabeticWoundHealingTgfBDynamics
