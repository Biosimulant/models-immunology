...
"""Auto-generated SBML BioModule wrapper for Bianca2013 - Persistence analysis in a Kolmogorov-type model for cancer-immune system competition.

Source: biomodels_ebi:BIOMD0000000900
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000900
"""
...
class SbmlBianca2013PersistenceAnalysisInAKolmogorovTypeModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Bianca2013 - Persistence analysis in a Kolmogorov-type model for cancer-immune system competition."""

    def __init__(self, model_path: str = "data/BIOMD0000000900.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bianca2013PersistenceAnalysisInAKolmogorovBiomd0000000900Model = SbmlBianca2013PersistenceAnalysisInAKolmogorovTypeModel
