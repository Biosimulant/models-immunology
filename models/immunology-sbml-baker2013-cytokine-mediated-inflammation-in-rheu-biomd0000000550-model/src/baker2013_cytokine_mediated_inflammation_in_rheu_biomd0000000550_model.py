...
"""Auto-generated SBML BioModule wrapper for Baker2013 - Cytokine Mediated Inflammation in Rheumatoid Arthritis.

Source: biomodels_ebi:BIOMD0000000550
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000550
"""
...
class SbmlBaker2013CytokineMediatedInflammationInRheumatoid(biosim.BioModule):
    """BioModule wrapper for SBML model: Baker2013 - Cytokine Mediated Inflammation in Rheumatoid Arthritis."""

    def __init__(self, model_path: str = "data/BIOMD0000000550.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Baker2013CytokineMediatedInflammationInRheuBiomd0000000550Model = SbmlBaker2013CytokineMediatedInflammationInRheumatoid
