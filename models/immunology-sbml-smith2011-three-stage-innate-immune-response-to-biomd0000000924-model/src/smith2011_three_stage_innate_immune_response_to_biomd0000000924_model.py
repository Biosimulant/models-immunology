...
"""Auto-generated SBML BioModule wrapper for Smith2011 - Three Stage Innate Immune Response to a Pneumococcal Lung Infection.

Source: biomodels_ebi:BIOMD0000000924
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000924
"""
...
class SbmlSmith2011ThreeStageInnateImmuneResponseToA(biosim.BioModule):
    """BioModule wrapper for SBML model: Smith2011 - Three Stage Innate Immune Response to a Pneumococcal Lung Infection."""

    def __init__(self, model_path: str = "data/BIOMD0000000924.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smith2011ThreeStageInnateImmuneResponseToBiomd0000000924Model = SbmlSmith2011ThreeStageInnateImmuneResponseToA
