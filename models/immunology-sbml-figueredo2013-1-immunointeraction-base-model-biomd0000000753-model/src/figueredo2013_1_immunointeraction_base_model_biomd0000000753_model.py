...
"""Auto-generated SBML BioModule wrapper for Figueredo2013/1 - immunointeraction base model.

Source: biomodels_ebi:BIOMD0000000753
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000753
"""
...
class SbmlFigueredo20131ImmunointeractionBaseModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Figueredo2013/1 - immunointeraction base model."""

    def __init__(self, model_path: str = "data/BIOMD0000000753.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Figueredo20131ImmunointeractionBaseModelBiomd0000000753Model = SbmlFigueredo20131ImmunointeractionBaseModel
