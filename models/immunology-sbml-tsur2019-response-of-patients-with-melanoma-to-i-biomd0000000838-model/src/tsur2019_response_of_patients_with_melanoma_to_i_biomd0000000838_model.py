...
"""Auto-generated SBML BioModule wrapper for Tsur2019 - Response of patients with melanoma to immune checkpoint blockade.

Source: biomodels_ebi:BIOMD0000000838
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000838
"""
...
class SbmlTsur2019ResponseOfPatientsWithMelanomaToImmune(biosim.BioModule):
    """BioModule wrapper for SBML model: Tsur2019 - Response of patients with melanoma to immune checkpoint blockade."""

    def __init__(self, model_path: str = "data/BIOMD0000000838.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tsur2019ResponseOfPatientsWithMelanomaToIBiomd0000000838Model = SbmlTsur2019ResponseOfPatientsWithMelanomaToImmune
