...
"""Auto-generated SBML BioModule wrapper for Hardiansyah2019 - QSP model of chimeric antigen receptor T-Cell therapy.

Source: biomodels_ebi:MODEL2009230001
Original: https://www.ebi.ac.uk/biomodels/MODEL2009230001
"""
...
class SbmlHardiansyah2019QspModelOfChimericAntigenReceptorT(biosim.BioModule):
    """BioModule wrapper for SBML model: Hardiansyah2019 - QSP model of chimeric antigen receptor T-Cell therapy."""

    def __init__(self, model_path: str = "data/MODEL2009230001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hardiansyah2019QspModelOfChimericAntigenReModel2009230001Model = SbmlHardiansyah2019QspModelOfChimericAntigenReceptorT
