...
"""Auto-generated SBML BioModule wrapper for Hancioglu2007 - Human Immune Response to Influenza A virus Infection.

Source: biomodels_ebi:BIOMD0000000711
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000711
"""
...
class SbmlHancioglu2007HumanImmuneResponseToInfluenzaAVirus(biosim.BioModule):
    """BioModule wrapper for SBML model: Hancioglu2007 - Human Immune Response to Influenza A virus Infection."""

    def __init__(self, model_path: str = "data/BIOMD0000000711.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hancioglu2007HumanImmuneResponseToInfluenzaBiomd0000000711Model = SbmlHancioglu2007HumanImmuneResponseToInfluenzaAVirus
