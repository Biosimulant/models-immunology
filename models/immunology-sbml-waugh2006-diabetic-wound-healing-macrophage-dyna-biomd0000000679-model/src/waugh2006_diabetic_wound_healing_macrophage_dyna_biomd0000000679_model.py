...
"""Auto-generated SBML BioModule wrapper for Waugh2006 - Diabetic Wound Healing - Macrophage Dynamics.

Source: biomodels_ebi:BIOMD0000000679
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000679
"""
...
class SbmlWaugh2006DiabeticWoundHealingMacrophageDynamics(biosim.BioModule):
    """BioModule wrapper for SBML model: Waugh2006 - Diabetic Wound Healing - Macrophage Dynamics."""

    def __init__(self, model_path: str = "data/BIOMD0000000679.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Waugh2006DiabeticWoundHealingMacrophageDynaBiomd0000000679Model = SbmlWaugh2006DiabeticWoundHealingMacrophageDynamics
