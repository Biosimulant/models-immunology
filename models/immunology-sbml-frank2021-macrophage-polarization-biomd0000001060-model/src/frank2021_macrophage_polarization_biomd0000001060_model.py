...
"""Auto-generated SBML BioModule wrapper for Frank2021 - Macrophage polarization.

Source: biomodels_ebi:BIOMD0000001060
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001060
"""
...
class SbmlFrank2021MacrophagePolarization(biosim.BioModule):
    """BioModule wrapper for SBML model: Frank2021 - Macrophage polarization."""

    def __init__(self, model_path: str = "data/BIOMD0000001060.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Frank2021MacrophagePolarizationBiomd0000001060Model = SbmlFrank2021MacrophagePolarization
