...
"""Curated Tellurium SBML wrapper for Nwabugwu2013 - A Tumor-Immune Mathematical Model of CD4+ T Helper Cell."""
...
class Nwabugwu2013ATumorImmuneMathematicalModelOModel2007090001Model(TelluriumSBMLBioModule):
    """Faithful BioModule wrapper around bundled SBML source MODEL2007090001."""

    _SBML_ID = 'MODEL2007090001'
    _TITLE = 'Nwabugwu2013 - A Tumor-Immune Mathematical Model of CD4+ T Helper Cell'
    ...
    _INITIAL_CONDITION_INPUTS = {'initial_memtcell': ('M', 10000000.0, 'native source value', 'Initial Memtcell. Sets the initial value of bundled SBML species `M`.'), 'initial_memhelpertcells': ('Mh', 6000000.0, 'native source value', 'Initial Memhelpertcells. Sets the initial value of bundled SBML species `Mh`.'), 'initial_memeffectorcells': ('Me', 3000000.0, 'native source value', 'Initial Memeffectorcells. Sets the initial value of bundled SBML species `Me`.'), 'initial_regmemtcell': ('Mr', 1000000.0, 'native source value', 'Initial Regmemtcell. Sets the initial value of bundled SBML species `Mr`.')}
    ...
    def __init__(self, model_path: str = 'data/MODEL2007090001.xml', integration_step: float = 0.1) -> None:
