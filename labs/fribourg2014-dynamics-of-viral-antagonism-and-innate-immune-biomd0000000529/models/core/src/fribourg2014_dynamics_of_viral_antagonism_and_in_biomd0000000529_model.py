...
"""Curated Tellurium SBML wrapper for Fribourg2014 - Dynamics of viral antagonism and innate immune response (H1N1 influenza A virus - NC/99)."""
...
class Fribourg2014DynamicsOfViralAntagonismAndInBiomd0000000529Model(TelluriumSBMLBioModule):
    """Faithful BioModule wrapper around bundled SBML source BIOMD0000000529."""

    _SBML_ID = 'BIOMD0000000529'
    _TITLE = 'Fribourg2014 - Dynamics of viral antagonism and innate immune response (H1N1 influenza A virus - NC/99)'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000529.xml', integration_step: float = 0.1) -> None:
