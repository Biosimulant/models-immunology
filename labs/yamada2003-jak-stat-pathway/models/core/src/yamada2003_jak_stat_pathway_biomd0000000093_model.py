...
"""Curated Tellurium SBML wrapper for Yamada2003_JAK_STAT_pathway."""
...
class Yamada2003JakStatPathwayBiomd0000000093Model(TelluriumSBMLBioModule):
    """Faithful BioModule wrapper around bundled SBML source BIOMD0000000093."""

    _SBML_ID = 'BIOMD0000000093'
    _TITLE = 'Yamada2003_JAK_STAT_pathway'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000093.xml', integration_step: float = 0.1) -> None:
