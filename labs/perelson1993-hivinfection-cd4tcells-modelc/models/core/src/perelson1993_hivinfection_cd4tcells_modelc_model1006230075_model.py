...
"""Curated Tellurium SBML wrapper for Perelson1993_HIVinfection_CD4Tcells_ModelC."""
...
class Perelson1993HivinfectionCd4tcellsModelcModel1006230075Model(TelluriumSBMLBioModule):
    """Faithful BioModule wrapper around bundled SBML source MODEL1006230075."""

    _SBML_ID = 'MODEL1006230075'
    _TITLE = 'Perelson1993_HIVinfection_CD4Tcells_ModelC'
    ...
    def __init__(self, model_path: str = 'data/MODEL1006230075.xml', integration_step: float = 0.1) -> None:
