...
class Sandip2013ModelingTheDynamicsOfHepatitisCBiomd0000000892Model(TelluriumSBMLBioModule):
    """Faithful BioModule wrapper around bundled SBML source BIOMD0000000892."""

    _SBML_ID = 'BIOMD0000000892'
    ...
    _PARAMETER_INPUTS = {}
    _INITIAL_CONDITION_INPUTS = {'initial_unresolved_infection_observable_1': ('T', 1000000.0, 'native source value', 'Initial Unresolved Infection Observable 1. Sets the initial value of bundled SBML species `T`.'), 'initial_unresolved_infection_observable_2': ('I', 1000000.0, 'native source value', 'Initial Unresolved Infection Observable 2. Sets the initial value of bundled SBML species `I`.'), 'initial_unresolved_infection_observable_3': ('VI', 10000000.0, 'native source value', 'Initial Unresolved Infection Observable 3. Sets the initial value of bundled SBML species `VI`.'), 'initial_unresolved_infection_observable_4': ('VNI', 1000000.0, 'native source value', 'Initial Unresolved Infection Observable 4. Sets the initial value of bundled SBML species `VNI`.')}
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000892.xml', integration_step: float = 0.1) -> None:
