...
"""Curated Tellurium SBML wrapper for Alexander2010_Tcell_Regulation_Sys1."""
...
class Alexander2010TcellRegulationSys1Biomd0000000289Model(TelluriumSBMLBioModule):
    """Faithful BioModule wrapper around bundled SBML source BIOMD0000000289."""

    _SBML_ID = 'BIOMD0000000289'
    _TITLE = 'Alexander2010_Tcell_Regulation_Sys1'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000289.xml', integration_step: float = 0.1) -> None:
