...
"""Curated Tellurium SBML wrapper for Waugh2006 - Diabetic Wound Healing - Macrophage Dynamics."""
...
class Waugh2006DiabeticWoundHealingMacrophageDynaBiomd0000000679Model(TelluriumSBMLBioModule):
    """Faithful BioModule wrapper around bundled SBML source BIOMD0000000679."""

    _SBML_ID = 'BIOMD0000000679'
    _TITLE = 'Waugh2006 - Diabetic Wound Healing - Macrophage Dynamics'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000679.xml', integration_step: float = 0.1) -> None:
