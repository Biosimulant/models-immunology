...
"""Curated Tellurium SBML wrapper for Waugh2006 - Diabetic Wound Healing - Treated and Untreated Macrophage Dynamics."""
...
class Waugh2006DiabeticWoundHealingTreatedAndUntBiomd0000000681Model(TelluriumSBMLBioModule):
    """Faithful BioModule wrapper around bundled SBML source BIOMD0000000681."""

    _SBML_ID = 'BIOMD0000000681'
    _TITLE = 'Waugh2006 - Diabetic Wound Healing - Treated and Untreated Macrophage Dynamics'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000681.xml', integration_step: float = 0.1) -> None:
